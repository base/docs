...
![debugger-selector](/images/openframes-fc/debugger-of-not-valid-zoom.png)
</Tip>


### Before:

![debugger-before](/images/openframes-fc/debugger-of-not-valid-zoom.png)

### After:

Your converted Farcaster Frame should pass all checks like the below image:
![debugger-after](/images/openframes-fc/frame-custom-no-url.png)
