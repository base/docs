...
3. When prompted:
   ...
   ![Template Creation Dialogue](/images/deployment-with-tenderly/create-template.png)
...
![Template Configuration Button](/images/deployment-with-tenderly/configuration.png)
...
3. Deploy your smart contract:
   ...
   ![output](/images/deployment-with-tenderly/output.png)
...
[Tenderly Debugger](https://docs.tenderly.co/debugger) allows you to pinpoint the exact line of code causing an issue and speed up your debugging process. With Debugger, you can step through code and inspect stack traces, filter internal and external calls, see decoded events and logs, examine state changes, and more.
...
![Devnet Transaction Capture](/images/deployment-with-tenderly/setgreeting.png)

- Click the **Debugger** button.

![Debugger Screen](/images/deployment-with-tenderly/debugger-button.png)
...
![Result from evaluating an expression in Tenderly](/images/deployment-with-tenderly/result-of-expression.png)
...
- Click the **New Simulation** button.
  ![DevNet Simulation Button](/images/deployment-with-tenderly/simulator-button.png)
...
- Modify the console.log to say `You changed the` to the console.log within **SetGreeting** in the `Greeter.sol` smart contract and click the **Apply** button.
  ![Editing Source Code of your smart contract](/images/deployment-with-tenderly/modifying-source.png)
- From the **Select Option** drop-down menu, select "**Set Greeting**."
- Change the greeting to something like, `Hello from Base!`
  ![Simulation using a new parameter as an input](/images/deployment-with-tenderly/simulation.png)
...
![Smart Contract Edit in Simulated Transaction](/images/deployment-with-tenderly/result-of-simulation.png)
...
5. For **VALUE**, enter `0x48656c6c6f2066726f6d2054656e6465726c79`
   ...
   ![State Override Portion of the Transaction Simulation Screen](/images/deployment-with-tenderly/overrides.png)
...
3. Adapt the `.github/workflows/smart-contract-ci.yml` with the following configuration, and replace `???` with [project slug](https://www.notion.so/o/-LeLQOwIQG3HndcULLU2/s/-LeLQaB11_TIOtLg8tIW/other/platform-access/how-to-find-the-project-slug-username-and-organization-name), [username](https://www.notion.so/o/-LeLQOwIQG3HndcULLU2/s/-LeLQaB11_TIOtLg8tIW/other/platform-access/how-to-find-the-project-slug-username-and-organization-name), and a DevNet template slug.
   ...
   ![Showing how to find TENDERLY_DEVNET_TEMPLATE](/images/deployment-with-tenderly/devnet-project-slug.png)
...
![Github Actions Linked with Tenderly](/images/deployment-with-tenderly/github-actions.png)
