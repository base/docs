...
<Steps>
  <Step title="Step 1: Create a Product in Coinbase Commerce">
  ...
  **Tip**: Store the product UUID as an environment variable in your `.env` file. This makes it easier to reference safely in your code.
  ...
  <Step title="Step 2: Clone the OnchainKit App Template">
  ...
  <Step title="Step 3: Configure Environment Variables">
  ...
  <Step title="Step 4: Configure Wagmi for Smart Wallets">
  ...
  <Step title="Step 5: Implement the Payment Component">
