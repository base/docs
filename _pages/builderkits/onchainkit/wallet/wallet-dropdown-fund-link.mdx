...
The `WalletDropdownFundLink` works just like the [`FundButton`](/builderkits/onchainkit/fund/fund-button) except that it's inside your wallet
dropdown menu.
...
- [`WalletDropdownFundLinkReact`](/builderkits/onchainkit/wallet/types#walletdropdownfundlinkreact)
