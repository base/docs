...
[`IsWalletACoinbaseSmartWalletResponse`](/builderkits/onchainkit/wallet/types#iswalletacoinbasesmartwalletresponse)

## Parameters

[`isWalletACoinbaseSmartWalletOptions`](/builderkits/onchainkit/wallet/types#iswalletacoinbasesmartwalletoptions)
