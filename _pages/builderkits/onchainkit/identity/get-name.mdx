...
See [GetNameReturnType](/builderkits/onchainkit/identity/types#getnamereturntype) and [GetName](/builderkits/onchainkit/identity/types#getname) for more details.
