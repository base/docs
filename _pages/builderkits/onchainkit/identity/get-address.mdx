...
See [`GetAddressReturnType`](/builderkits/onchainkit/identity/types#getaddressreturntype) and [`GetAddress`](/builderkits/onchainkit/identity/types#getaddress) for more details.
