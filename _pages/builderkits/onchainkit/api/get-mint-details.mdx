...
[`Promise<GetMintDetailsResponse>`](/builderkits/onchainkit/api/types#getmintdetailsresponse)
...
- [`GetMintDetailsResponse`](/builderkits/onchainkit/api/types#getmintdetailsresponse)
- [`GetMintDetailsParams`](/builderkits/onchainkit/api/types#getmintdetailsparams)
