...
[`Promise<GetTokenDetailsResponse>`](/builderkits/onchainkit/api/types#gettokendetailsresponse)

## Parameters

[`GetTokenDetailsParams`](/builderkits/onchainkit/api/types#gettokendetailsparams)

## Types

- [`GetTokenDetailsResponse`](/builderkits/onchainkit/api/types#gettokendetailsresponse)
- [`GetTokenDetailsParams`](/builderkits/onchainkit/api/types#gettokendetailsparams)
