...
The `Swap` components provide a comprehensive interface for users to execute [Token](/builderkits/onchainkit/token/types#token) swaps.
...
[`SwapDefaultReact`](/builderkits/onchainkit/swap/types#swapdefaultreact)
...
- `<SwapAmountInput />` - Set the [Token](/builderkits/onchainkit/token/types#token) to swap and specify the input type (`from` or `to`).
...
- [`SwapReact`](/builderkits/onchainkit/swap/types#swapreact)
- [`SwapDefaultReact`](/builderkits/onchainkit/swap/types#swapdefaultreact)
- [`SwapAmountInputReact`](/builderkits/onchainkit/swap/types#swapamountinputreact)
- [`SwapButtonReact`](/builderkits/onchainkit/swap/types#swapbuttonreact)
- [`SwapMessageReact`](/builderkits/onchainkit/swap/types#swapmessagereact)
- [`SwapToggleButtonReact`](/builderkits/onchainkit/swap/types#swaptogglebuttonreact)
- [`SwapToastReact`](/builderkits/onchainkit/swap/types#swaptoastreactt)
