...
function _createMdxContent(props) {
  ...
  return <Expandable title="Filter options (logs only)"><ParamField body="address" type="string | array"><_components.p>{"A contract address or array of addresses to filter by. Optional."}</_components.p></ParamField><ParamField body="topics" type="array"><_components.p>{"Array of topic filters in the same format as "}<_components.code>{"eth_getLogs"}</_components.code>{". Optional."}</_components.p></ParamField></Expandable>;
}
