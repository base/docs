---
title: "Send Tokens"
description: "Send ETH or any ERC-20 token to an address, ENS name, basename, or cb.id using the Base Account MCP"
keywords: ["send tokens AI", "send USDC AI assistant", "send ETH AI", "Base Account MCP send", "ENS basename send AI"]
---
