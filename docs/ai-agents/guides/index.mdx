---
title: "Guides"
description: "Step-by-step guides for common things to do with your Base Account MCP"
keywords: ["Base Account MCP guides", "send tokens AI", "swap tokens AI", "check balance AI", "x402 payments AI"]
---
