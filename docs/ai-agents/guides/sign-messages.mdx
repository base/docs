---
title: "Sign Messages"
description: "Sign EIP-712 typed data and plain messages with your Base Account using the Base Account MCP"
keywords: ["sign message AI", "EIP-712 sign AI", "personal_sign AI", "Base Account MCP sign", "sign typed data AI assistant"]
---
...
<Steps>
  <Step title="Your assistant calls sign()">
    Passes the message type and payload to the Base Account MCP.
  </Step>
