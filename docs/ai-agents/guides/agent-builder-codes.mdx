...
Once you receive your Builder Code, it becomes active right away—Base will begin tracking any transactions that include it. To view your analytics, prompt your agent to perform a transaction (like a token swap), and then visit [Base.dev](https://base.dev) to see your updated transaction count.
