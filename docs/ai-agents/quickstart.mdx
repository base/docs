...
<Steps>
  <Step title="Connect the MCP">
    <Tabs>
      <Tab title="Claude">
        <a href="https://claude.ai/customize/connectors?modal=add-custom-connector&connectorName=Base&connectorUrl=https%3A%2F%2Fmcp.base.org">
  ...
  <Step title="Install the skill">
    ...
    <Tabs>
      <Tab title="Claude">
        <a href="https://github.com/base/skills/raw/refs/heads/youssef/add-build-on-base-and-base-mcp/skills/base-mcp/base-mcp-v0.1.1.zip">
