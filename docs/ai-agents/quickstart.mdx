    ...
    <Tabs>
      ...
      <Tab title="ChatGPT">
        ...
        **Option 1: Drop the zip into a conversation**
        ...
        Attach the downloaded `base-mcp.zip` to a new ChatGPT conversation and ask ChatGPT to read the skill and onboard you. Works on any ChatGPT plan, the quickest way to try it without changing any settings.
