    ...
    <Tabs>
      <Tab title="Claude">
        **Option 1: Paste this prompt into a new conversation**
        ...
        <Prompt description="Onboard via the hosted SKILL.md">
        Use Base MCP. Read `https://base-a060aa97-youssef-update-agents.mintlify.app/ai-agents/skills/SKILL.md` and follow its onboarding. If your built-in web tool can't fetch the link, use the `web_request` tool from Base MCP instead.
        </Prompt>
