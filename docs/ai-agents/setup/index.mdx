---
title: "Setup"
description: "Connect the Base Account MCP to Claude Desktop, Claude.ai, ChatGPT, Claude Code, Cursor, VS Code, Windsurf, Zed, JetBrains, Le Chat, Warp, and more"
keywords: ["mcp.base.org setup", "Base Account MCP install", "Claude Desktop MCP config", "ChatGPT MCP connector", "Claude Code MCP", "Cursor MCP", "VS Code MCP", "Windsurf MCP", "Zed MCP", "JetBrains MCP"]
---
