...
The canonical registry addresses are in [contract addresses](/ai-agents/reference/contracts).
...
<CardGroup cols={2}>
  <Card title="Contract addresses" icon="file-contract" href="/ai-agents/reference/contracts">
    ERC-8004 registry and x402 facilitator addresses on Base.
  </Card>

  <Card title="x402 protocol" icon="bolt" href="/ai-agents/payments/x402-protocol">
