...
description: 'Base-specific patterns, fee calibration, and onchain signals for trading agents. Covers what is unique to Base and not covered in the general docs.'
---
