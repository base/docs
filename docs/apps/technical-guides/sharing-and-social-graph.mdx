...
<CardGroup cols={2}>
  <Card title="useViewCast" icon="book-open" href="/mini-apps/core-concepts/navigation" />
  <Card title="useViewProfile" icon="book-open" href="/mini-apps/core-concepts/navigation" />
</CardGroup>
