...
description: "Build financial products on Base by outcome: integrate DeFi, tokenize assets, issue stablecoins, accept payments, or run private transactions."
---
...
<CardGroup cols={2}>
  <Card title="Chain" icon="link" href="/specifications/overview">
