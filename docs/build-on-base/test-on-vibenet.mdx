...
<CardGroup cols={2}>
  ...
  <Card title="Native Account Abstraction (EIP-8130)" icon="key" href="/specifications/native-account-abstraction">
    Onchain smart accounts, scoped session keys, and native gas sponsorship, previewing on Vibenet.
  </Card>
  <Card title="200ms Native Blocks" icon="clock" href="/upgrades/cobalt/200ms-blocks">
