...
- [Cancel blocked shares](/build-on-base/issue-rwa/cancel-blocked-units) · [Pause transfers](/build-on-base/issue-rwa/pause-transfers)
- [Policy Registry](/base-chain/specs/reference/b20#policy-registry) and [Policy integration](/base-chain/specs/reference/b20#policy-integration) in the B20 standard
