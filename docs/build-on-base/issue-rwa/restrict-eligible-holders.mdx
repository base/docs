...
Create an allowlist in the [Policy Registry](/specifications/b20/concepts/policies#21-the-registry-and-the-token), then apply it when shares are issued, sent, or received. Accounts remain ineligible until the policy admin adds them.
...
<CardGroup cols={2}>
  <Card title="Restrict Who Can Initiate Transfers" icon="user-shield" href="/build-on-base/issue-rwa/restrict-transfer-initiators">
    Require a designated initiator for every transfer.
  </Card>
