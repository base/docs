...
<CardGroup cols={2}>
  <Card title="Cancel blocked shares" href="/build-on-base/issue-rwa/cancel-blocked-units" />
  <Card title="Pause transfers" href="/build-on-base/issue-rwa/pause-transfers" />
</CardGroup>
