...
Create an allowlist in the [Policy Registry](/specifications/b20#integrating-compliance-checks), then apply it when shares are issued, sent, or received. Accounts remain ineligible until the policy admin adds them.
