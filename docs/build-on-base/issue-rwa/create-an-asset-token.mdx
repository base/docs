...
- [Issue shares](/build-on-base/issue-rwa/issue-units) · [Restrict eligible holders](/build-on-base/issue-rwa/restrict-eligible-holders)
- [Asset variant](/base-chain/specs/reference/b20#asset), [Factory](/base-chain/specs/reference/b20#factory), and [Supply cap](/base-chain/specs/reference/b20#supply-cap) in the B20 standard
