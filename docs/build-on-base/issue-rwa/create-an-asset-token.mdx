...
<CardGroup cols={2}>
  <Card title="Issue shares" href="/build-on-base/issue-rwa/issue-units" />
  <Card title="Restrict eligible holders" href="/build-on-base/issue-rwa/restrict-eligible-holders" />
</CardGroup>
