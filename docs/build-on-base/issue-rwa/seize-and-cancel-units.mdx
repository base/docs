...
To announce the cancellation to holders and indexers, wrap the `burnWithMemo` in `announce`; see [Announce a Change to Holders](/build-on-base/issue-rwa/announce-a-distribution).
