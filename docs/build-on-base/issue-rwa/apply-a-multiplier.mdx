...
To disclose the schedule to holders and indexers in the same transaction, wrap the call in `announce`; see [Announce a Change to Holders](/build-on-base/issue-rwa/announce-a-distribution).
...
<CardGroup cols={2}>
  <Card title="Announce a Change to Holders" icon="bullhorn" href="/build-on-base/issue-rwa/announce-a-distribution">
