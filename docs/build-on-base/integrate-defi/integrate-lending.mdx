...
<CardGroup cols={2}>
  <Card title="Integrate borrowing" href="/build-on-base/integrate-defi/integrate-borrowing" />
  <Card title="Integrate an earn product" href="/build-on-base/integrate-defi/integrate-earn-product" />
</CardGroup>
