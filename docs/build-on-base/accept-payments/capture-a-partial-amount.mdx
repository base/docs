...
Capture less than the authorized amount when the final total changes after checkout, or capture multiple increments as an order ships. The remaining reservation is tracked onchain without a custom checkout contract.
