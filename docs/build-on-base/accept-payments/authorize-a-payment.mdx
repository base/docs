...
description: "Move payer funds into Commerce Payments Protocol escrow for later capture on Base."
---
...
```typescript TypeScript lines wrap expandable highlight={6,11-18,21-24}
