...
description: "Build a settlement report from Commerce Payments Protocol charges, captures, fees, voids, reclaims, and refunds."
---
...
```typescript TypeScript backend lines wrap expandable highlight={4-11,14-24,25-35}
