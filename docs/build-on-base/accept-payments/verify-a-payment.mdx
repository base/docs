...
<CardGroup cols={2}>
  <Card title="Accept payments from humans" href="/build-on-base/accept-payments/from-humans" />
  <Card title="Accept payments from agents" href="/build-on-base/accept-payments/from-agents" />
</CardGroup>
