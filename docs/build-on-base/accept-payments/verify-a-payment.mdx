...
description: "Verify confirmed Commerce Payments Protocol events and claim each settlement exactly once before fulfillment."
---
...
```typescript Backend lines wrap expandable highlight={8-18,21-27}
