...
<CardGroup cols={2}>
  ...
  <Card title="Capture an Authorization" icon="receipt" href="/build-on-base/accept-payments/capture-an-authorization">Build the wallet-checkout version with a constrained permit.</Card>
</CardGroup>
