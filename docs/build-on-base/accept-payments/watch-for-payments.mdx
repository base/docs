...
Choose a confirmation policy that matches your risk tolerance. See [transaction finality](/specifications/transactions/transaction-finality) for Base's confirmation stages.
