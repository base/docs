...
description: "Watch Commerce Payments Protocol events, backfill missed blocks, and process confirmed lifecycle changes idempotently."
---
...
```typescript TypeScript worker lines wrap expandable highlight={6-13,16-23,29-35}
