...
Refund all or part of a protocol charge or capture before `refundExpiry`. The refundable limit is maintained onchain, and refunds are always sent to `paymentInfo.payer`.
