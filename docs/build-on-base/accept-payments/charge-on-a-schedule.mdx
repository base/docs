...
First collect and store a permission with the [Spend Permissions guide](https://docs.cdp.coinbase.com/coinbase-wallet/improve-ux/spend-permissions). At each billing time, check its current status before preparing calls.
...
<CardGroup cols={2}>
  <Card title="Spend Permissions SDK" icon="key" href="https://docs.cdp.coinbase.com/coinbase-wallet/improve-ux/spend-permissions">
    Request, inspect, spend, and revoke permissions.
  </Card>
  <Card title="Subscriptions API Reference" icon="calendar" href="https://docs.cdp.coinbase.com/coinbase-wallet/reference/base-pay/subscriptions-overview">
