...
description: "Create one escrow-backed charge per billing period using a smart-wallet spend permission."
---
...
```typescript TypeScript lines wrap expandable highlight={8-10,13-22,25-28}
