...
description: "Create one Commerce Payments Protocol charge per billing period using a smart-wallet spend permission."
---
...
<Warning>
Commerce Payments Protocol does not run a scheduler. Protect the operator key, serialize retries, and do not reuse a prior period's `PaymentInfo` or salt.
</Warning>
