...
<CardGroup cols={2}>
  <Card title="Mint supply" href="/build-on-base/issue-stablecoins/mint-supply" />
  <Card title="Restrict who can hold it" href="/build-on-base/issue-stablecoins/restrict-who-can-hold" />
</CardGroup>
