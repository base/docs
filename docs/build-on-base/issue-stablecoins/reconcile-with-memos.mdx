...
<CardGroup cols={2}>
  <Card title="Request a Commerce Payment" icon="credit-card" href="/build-on-base/accept-payments/request-a-payment">
    Use a compatible collector when token policies allow protocol payment transfers.
  </Card>
