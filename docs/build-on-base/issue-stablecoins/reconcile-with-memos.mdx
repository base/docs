...
<CardGroup cols={2}>
  <Card title="Accept a B20 payment" href="/build-on-base/accept-payments/from-humans#accept-b20-with-a-memo" />
  <Card title="Query B20 events (CDP SQL API)" href="https://docs.cdp.coinbase.com/data/sql-api/b20-events" />
</CardGroup>
