...
<CardGroup cols={2}>
  <Card title="Configure a Commerce Payment" icon="credit-card" href="/build-on-base/accept-payments/configure-a-payment">
    Set the token, amount, parties, expiry windows, and fee bounds for a protocol payment.
  </Card>
