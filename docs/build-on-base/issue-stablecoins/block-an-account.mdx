...
<CardGroup cols={2}>
  <Card title="Recover funds" href="/build-on-base/issue-stablecoins/recover-funds" />
  <Card title="Pause activity" href="/build-on-base/issue-stablecoins/pause-activity" />
</CardGroup>
