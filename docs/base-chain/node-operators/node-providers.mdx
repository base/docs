...
[Blockmachine](https://blockmachine.io/base-rpc) offers some of the lowest Base RPC prices on the market, with a free keyless public endpoint and no signup required. Standard JSON-RPC, no proprietary extensions, no lock-in.

See [pricing](https://blockmachine.io/pricing) and [Base RPC quickstart](https://blockmachine.io/docs/base-rpc).
