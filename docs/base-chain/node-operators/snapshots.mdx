...
<Accordion title="How'd I run my previous prune node setup with v2-storage?">

If your v1-storage pruned node had a pruning distance of more than 10064 blocks, it is required to pull an Archival snapshot and then adding the prune args.

Full will not work because it'll only have the lastt 10064 blocks.
