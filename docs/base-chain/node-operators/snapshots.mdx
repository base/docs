...
<AccordionGroup>
<Accordion title="What is a Full node?">
...
<Accordion title="How can I initially run my Pruned node from v1 storage?">

Because the Full node only keeps the last 10064 blocks, any prune distance greater than 10064 will require pulling an Archival snapshot and then adding the prune args.
