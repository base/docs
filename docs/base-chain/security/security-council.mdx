...
- [Individual] Toady Hawk – based in Canada
  - [Toady Hawk](https://farcaster.com/toadyhawk.eth) is the founder of [Zero Rights Media](https://farcaster.com/zerorightsmedia), an open source onchain media org on Base (producers of ZEROPOD), and [The Yellow Collective](https://farcaster.com/basedandyellow), an onchain culture club for artists and creators on Base.
  - `0x0E8A99738a50D523871739c6d676554b0E34252f`
- [Individual] Roberto Bayardo – based in USA
  - [Roberto Bayardo](https://farcaster.com/bayardo.eth) is an engineer at Commonware, building a framework for high-performance blockchains. He is a former core Base contributor.
