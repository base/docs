...
9 of them (the CB Signers plus at least 8 Security Council members). This meets
each Stage 1 requirement: at least 8 participants, a ≥75% quorum, and—because
the Security Council's 8-of-11 threshold sits outside Coinbase—a quorum-blocking
group independent of Base. Upgrades cannot take effect until both parties reach
their thresholds.
