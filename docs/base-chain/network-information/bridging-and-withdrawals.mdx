...
description: How assets and messages move between Base and other chains, including withdrawal lifecycle, timing, and finality dependencies.
---
...
Partner and user-facing withdrawal expectations should be set around the native withdrawal lifecycle: initiate on Base, wait for the output root to be available on Ethereum, prove the withdrawal, wait through the fault proof challenge window, then finalize on Ethereum.
