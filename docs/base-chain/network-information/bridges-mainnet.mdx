...
Garden is a fast, non-custodial Bitcoin bridge that enables trustless BTC swaps and seamless cross-chain transfers, bridging BTC, ETH, SOL, USDC, and more from native Bitcoin, Ethereum, Solana, Arbitrum, and other chains directly to Base.
