...
[OpenFaucet.org](https://openfaucet.org/base-sepolia) is a Proof of Work multi-chain faucet with minimal usage requirements. It doesn't require any sign up or mainnet balance to claim tokens.

<Note>
Requests to OpenFaucet are limited to 2 claims per hour.
</Note>
