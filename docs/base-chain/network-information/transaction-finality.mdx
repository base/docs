...
<Frame>
![Diagram illustrating the four stages of transaction finality on Base: Flashblock Inclusion (200ms), L2 Block Inclusion (2s), L1 Batch Inclusion (2m), and L1 Batch Finality (20m)](/images/transaction-finality/base-tx-finality.jpg)
</Frame>
