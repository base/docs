...
Flashblocks-aware nodes provide all standard Ethereum JSON-RPC methods plus specialized Flashblocks endpoints. For the full list of supported methods and subscription types, see the [JSON-RPC API Reference](/base-chain/reference/json-rpc-api).
