---
title: Run a Flashblocks Node
sidebarTitle: Run a Flashblocks Node
---
...
1. **Prerequisites**:
  ...
  - Minimum hardware requirements (see [node README](https://github.com/base/node?tab=readme-ov-file#requirements))
...
Flashblocks-aware nodes provide all standard Ethereum JSON-RPC methods plus specialized Flashblocks endpoints. For the full list of supported methods and subscription types, see the [JSON-RPC API Reference](/base-chain/api-reference/rpc-overview).
