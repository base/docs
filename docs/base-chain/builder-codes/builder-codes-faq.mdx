...
- Visit the [base.dev](https://base.dev) 
- Select Onchain from the transaction type drop down 
- Under the Total Transaction section attribution counts increment when transactions with your code are processed
...
- Select transactiion type
- Enter in the Transaction or UserOperation Hash 
- Click the **Check Attribution** 
