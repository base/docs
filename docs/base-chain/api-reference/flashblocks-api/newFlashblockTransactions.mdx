...
<Info>
This subscription requires a WebSocket-enabled RPC endpoint. The public Base endpoints (`mainnet.base.org`, `sepolia.base.org`) are HTTP only. Choose a WebSocket-capable provider from the [Builder Stack](/get-started/builder-stack).
</Info>
