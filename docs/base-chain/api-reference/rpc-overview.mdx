...
Most apps should start with Standard RPC. Use Flashblocks RPC when faster state reads, transaction feedback, or realtime subscriptions materially improve the user experience. For endpoint URLs and chain IDs, see [Connecting to Base](/base-chain/quickstart/connecting-to-base).
...
<CardGroup cols={2}>
  <Card title="Read state" href="/base-chain/api-reference/ethereum-json-rpc-api/eth_call">
    Query balances, storage, bytecode, and nonces. Use `"pending"` on Flashblocks RPC for preconfirmed state.
  </Card>
  <Card title="Send transactions" href="/base-chain/api-reference/ethereum-json-rpc-api/eth_sendRawTransaction">
    Broadcast signed transactions to the network.
  </Card>
  <Card title="Track confirmations" href="/base-chain/api-reference/ethereum-json-rpc-api/eth_getTransactionReceipt">
    Poll for receipts on sealed blocks, or get preconfirmed data on Flashblocks RPC.
  </Card>
  <Card title="Stream realtime data" href="/base-chain/api-reference/ethereum-json-rpc-api/eth_subscribe">
    WebSocket subscriptions for new blocks, logs, and preconfirmed transaction data.
  </Card>
  <Card title="Simulate preconfirmed bundles" href="/base-chain/api-reference/flashblocks-api/eth_simulateV1">
    Run transaction bundles against preconfirmed state before they land on-chain.
  </Card>
  <Card title="Debug execution" href="/base-chain/api-reference/debug-api/debug_traceTransaction">
    Full EVM traces and block replay. Availability varies by provider.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="State and contract reads" href="/base-chain/api-reference/ethereum-json-rpc-api/eth_call">
    Account balances, storage slots, bytecode, nonces, and contract simulation.
  </Card>
  <Card title="Blocks and transactions" href="/base-chain/api-reference/ethereum-json-rpc-api/eth_getBlockByNumber">
    Block data, transaction lookups, and receipts by hash, number, or index.
  </Card>
  <Card title="Fees and gas" href="/base-chain/api-reference/ethereum-json-rpc-api/eth_estimateGas">
    Gas estimation, current gas price, priority fee, and fee history.
  </Card>
  <Card title="Logs and subscriptions" href="/base-chain/api-reference/ethereum-json-rpc-api/eth_getLogs">
    Filter and query event logs, or subscribe to events over WebSocket.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Transaction status" href="/base-chain/api-reference/flashblocks-api/base_transactionStatus">
    Check if a transaction has reached the mempool before it seals into an L2 block.
  </Card>
  <Card title="Pending logs" href="/base-chain/api-reference/flashblocks-api/pendingLogs">
    Subscribe to filtered event logs from preconfirmed transactions.
  </Card>
  <Card title="New Flashblock transactions" href="/base-chain/api-reference/flashblocks-api/newFlashblockTransactions">
    Subscribe to individual transactions as they are preconfirmed.
  </Card>
  <Card title="Flashblock stream" href="/base-chain/api-reference/flashblocks-api/newFlashblocks">
    Subscribe to full Flashblock payloads for apps that need the raw block shape.
  </Card>
</CardGroup>

### Debug API

Debug methods replay transactions and blocks for development and incident analysis. They are computationally expensive, so availability and rate limits vary by [RPC provider](/base-chain/network-information/rpc-providers).

<CardGroup cols={2}>
  <Card title="Trace a transaction" href="/base-chain/api-reference/debug-api/debug_traceTransaction">
    Full EVM execution trace for a single transaction.
  </Card>
  <Card title="Trace a block" href="/base-chain/api-reference/debug-api/debug_traceBlockByNumber">
    Replay and trace all transactions in a block by number or hash.
  </Card>
</CardGroup>
