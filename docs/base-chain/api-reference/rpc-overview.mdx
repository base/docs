...
<Tabs>
  <Tab title="Mainnet">
    | | HTTP | WSS |
    | :--- | :--- | :--- |
    | RPC | `https://mainnet.base.org` | `wss://mainnet.flashblocks.base.org/ws` |
  </Tab>
  <Tab title="Sepolia">
    | | HTTP | WSS |
    | :--- | :--- | :--- |
    | RPC | `https://sepolia.base.org` | `wss://sepolia.flashblocks.base.org/ws` |
  </Tab>
</Tabs>
...
<Note>
Standard WebSocket endpoints (`wss://mainnet.base.org`, `wss://sepolia.base.org`) are not currently available. For WebSocket subscriptions (`eth_subscribe`, `newHeads`, `logs`), use the Flashblocks WSS endpoints listed above.
</Note>
