...
<Tabs>
  <Tab title="Mainnet">
    ...
    | Flashblocks | `https://mainnet-preconf.base.org` | `wss://mainnet.flashblocks.base.org/ws` |
  </Tab>
  <Tab title="Sepolia">
    | Tier | HTTP | WSS |
    | :--- | :--- | :--- |
    | Standard | `https://sepolia.base.org` | — |
    | Flashblocks | `https://sepolia-preconf.base.org` | `wss://sepolia.flashblocks.base.org/ws` |
  </Tab>
</Tabs>
...
<Note>
The standard WebSocket endpoints (`wss://mainnet.base.org`, `wss://sepolia.base.org`) are not currently available. For WebSocket subscriptions (`eth_subscribe`, `newHeads`, `logs`), use the Flashblocks WSS endpoints listed above.
</Note>
