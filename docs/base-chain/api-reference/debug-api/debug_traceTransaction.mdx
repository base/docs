...
<Warning>
Debug methods replay transactions and are computationally expensive. Availability and rate limits vary by [RPC provider](/base-chain/network-information/rpc-providers). Avoid calling these in hot paths.
</Warning>
