...
<Warning>
Debug methods replay transactions and are computationally expensive. Availability and rate limits vary among providers in the [Builder Stack](/get-started/builder-stack). Avoid calling these in hot paths.
</Warning>
