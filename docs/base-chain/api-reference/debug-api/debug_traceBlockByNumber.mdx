...
<Warning>
Debug methods replay all transactions in the block and are computationally expensive. Availability varies among providers in the [Base Services Hub](/get-started/base-services-hub).
</Warning>
