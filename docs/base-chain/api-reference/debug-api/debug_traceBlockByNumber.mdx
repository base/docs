...
<Warning>
Debug methods replay all transactions in the block and are computationally expensive. Availability varies by [RPC provider](/base-chain/network-information/rpc-providers).
</Warning>
