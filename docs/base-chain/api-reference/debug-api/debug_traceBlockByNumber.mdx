...
<Warning>
Debug methods replay all transactions in the block and are computationally expensive. Availability varies among providers in the [Builder Stack](/get-started/builder-stack).
</Warning>
