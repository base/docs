---
title: 'eth_getBlockTxCountByNumber'
sidebarTitle: 'eth_getBlockTxCountByNumber'
description: 'eth_getBlockTransactionCountByNumber — Returns the number of transactions in a block by block number.'
---
