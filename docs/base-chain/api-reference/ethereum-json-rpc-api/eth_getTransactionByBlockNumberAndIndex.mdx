---
title: 'eth_getTxByBlockNumberAndIndex'
sidebarTitle: 'eth_getTxByBlockNumberAndIndex'
description: 'eth_getTransactionByBlockNumberAndIndex — Returns a transaction by block number and index position.'
---
