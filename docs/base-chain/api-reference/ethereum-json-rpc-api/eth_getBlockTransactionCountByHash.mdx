---
title: 'eth_getBlockTxCountByHash'
sidebarTitle: 'eth_getBlockTxCountByHash'
description: 'eth_getBlockTransactionCountByHash — Returns the number of transactions in a block by block hash.'
---
