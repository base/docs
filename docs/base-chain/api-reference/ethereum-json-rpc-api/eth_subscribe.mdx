...
<Note>
The public Base endpoints (`mainnet.base.org`, `sepolia.base.org`) are **HTTP only**. WebSocket connections are not available on public Base endpoints — choose a WebSocket-capable provider from the [Builder Stack](/get-started/builder-stack).
</Note>
