---
title: 'eth_getTxByBlockHashAndIndex'
sidebarTitle: 'eth_getTxByBlockHashAndIndex'
description: 'eth_getTransactionByBlockHashAndIndex — Returns a transaction by block hash and index position.'
---
