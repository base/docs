...
<Note>
For production systems, we recommend using a hosted endpoint from one of the [RPC providers](/base-chain/network-information/rpc-providers), or [running your own Base node](/base-chain/node-operators/run-a-base-node).
</Note>
