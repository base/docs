...
| RPC Endpoint                | [https://mainnet.base.org](https://mainnet.base.org)<br/>_Flashblocks-enabled. Rate limited and not for production systems._                   |
| Chain ID                    | 8453                                                                                                                      |
| Currency Symbol             | ETH                                                                                                                       |
...
| RPC Endpoint                | [https://sepolia.base.org](https://sepolia.base.org)<br/>_Flashblocks-enabled. Rate limited and not for production systems._                   |
| Chain ID                    | 84532                                                                                                                     |
| Currency Symbol             | ETH                                                                                                                       |
