...
- **Cheap, fast, and open platform:** Base is a globally available platform that provides 1-second and &lt;1-cent fee transactions to anyone in the world.
- **Access to high-quality tooling:** Builders have access to tools, infrastructure and support to build incredible onchain experiences for AI, social, media, and entertainment.
...
Base is a global onchain economy of people, content creators, builders, and businesses creating the next generation of the open internet. It enables builders to:
...
It’s fast, cheap, and permissionless, meaning anyone can build, contribute and use applications on Base.
...
Developers choose Base for the following:

- Always-on global payment rail operating at internet speed
- Low-cost transactions (often less than a cent)
- Robust developer tooling and support
...
Some of the tooling that makes this possible include:
