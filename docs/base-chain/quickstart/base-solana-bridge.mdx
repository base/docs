...
This is a convenience feature we are operating on top of the bridge to reduce friction in the Solana -> Base direction.
</Info>
...
### Auto-Relay Example
We have a sample script that shows how to bridge SOL with auto-relay
