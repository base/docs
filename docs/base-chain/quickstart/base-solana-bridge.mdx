...
Builder codes allow developers to attribute bridge traffic and receive rewards when users bridge through their applications. For detailed implementation instructions on integrating Builder Codes with the Solana → Base bridge flow, see the [Builder Codes guide](/base-chain/quickstart/builder-codes#for-base-solana-bridge-developers).
