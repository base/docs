...
1. **Initiate the bridge on Solana** - Lock your SOL in a Solana vault
...
<GithubRepoCard title="Base to Solana Example" githubUrl="https://github.com/base/base-bridge-examples/tree/main/bridgeSolFromBaseToSolana" />
...
<GithubRepoCard title="Base Bridge Examples - Utilities" githubUrl="https://github.com/base/base-bridge-examples/tree/main/bridgeSolFromBaseToSolana/utils" />
...
<CardGroup cols={2}>
  <Card title="GitHub Repository" icon="github" href="https://github.com/base/base-bridge-examples">
