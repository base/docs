...
[Dwellir](https://www.dwellir.com/) is a Blockchain-as-a-Service (BaaS) platform that provides API access to archive nodes for Base. They offer 15 million responses on their free plan and $2 per million on paid plans.
