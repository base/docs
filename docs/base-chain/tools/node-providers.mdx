...
[Dwellir](https://www.dwellir.com/) is a Blockchain-as-a-Service (BaaS) platform that provides API access to archive nodes for Base. They offer a generous 25 million response free plan and best-in-class pricing for paid plans.
