...
[ethfaucet.com](https://ethfaucet.com/) provides developers with free Base Sepolia testnet ETH and small amounts of Base mainnet ETH for contract deployment.  
It is operated and maintained by [BringID](https://www.bringid.org/).

<Note>
Limits: 0.5 Base Sepolia ETH per 24 hours, and a single lifetime claim for Base Mainnet ETH.
</Note>
