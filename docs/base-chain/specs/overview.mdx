...
originally built on the [OP Stack](https://specs.optimism.io). After the [Azul hardfork](/base-chain/specs/upgrades/azul/overview), Base Chain runs on the Base Stack and follows this specification.
