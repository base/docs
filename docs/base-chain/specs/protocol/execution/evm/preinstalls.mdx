...
[Preinstalled smart contracts](../../../reference/glossary.mdx#preinstalled-contract-preinstall) exist on Base
...
as [Predeployed smart contracts](../../../reference/glossary.mdx#predeployed-contract-predeploy).
