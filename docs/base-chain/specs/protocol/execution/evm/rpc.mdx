...
description: "JSON-RPC methods implemented by the Flashblocks RPC provider, including modifications that support querying preconfirmed state via the pending tag and new methods for retrieving and subscribing to flashblocks."
---
