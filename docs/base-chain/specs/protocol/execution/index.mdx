...
Starting with Holocene, the EIP-1559 parameters become [dynamically configurable](../../upgrades/holocene/exec-engine.mdx#dynamic-eip-1559-parameters).

Starting with Jovian, a [configurable minimum base fee](../../upgrades/jovian/exec-engine.mdx#minimum-base-fee) is introduced.
...
With Holocene, the `extraData` field [encodes the EIP-1559 parameters](../../upgrades/holocene/exec-engine.mdx#dynamic-eip-1559-parameters).

With Jovian, the `extraData` encoding is extended to [include `minBaseFee`](../../upgrades/jovian/exec-engine.mdx#minimum-base-fee).
...
[deposit-spec]: ../bridging/deposits.mdx
...
| ------------------- | ------------------------------------------------------ |
| Sequencer Fee Vault | [`SequencerFeeVault`](evm/predeploys.mdx#sequencerfeevault) |
| Base Fee Vault      | [`BaseFeeVault`](evm/predeploys.mdx#basefeevault)           |
| L1 Fee Vault        | [`L1FeeVault`](evm/predeploys.mdx#l1feevault)               |
...
[rollup-driver]: ../consensus/index.mdx
...
See [Dynamic EIP-1559 Parameters](../../upgrades/holocene/exec-engine.mdx#dynamic-eip-1559-parameters) for details.

Starting with Jovian, the `minBaseFee` field is added. It must be `null` before Jovian.
See [Jovian Minimum Base Fee](../../upgrades/jovian/exec-engine.mdx#minimum-base-fee) for details.
