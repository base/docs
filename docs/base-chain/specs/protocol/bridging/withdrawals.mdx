...
[g-withdrawal]: ../../reference/glossary.mdx#withdrawal
[g-relayer]: ../../reference/glossary.mdx#withdrawals
[g-execution-engine]: ../../reference/glossary.mdx#execution-engine
...
When a contract makes a deposit, the sender's address is [aliased](deposits.mdx#address-aliasing). The same is not true
...
the [OptimismPortal](deposits.mdx#deposit-contract) contract, and in addition provides the following interface for
withdrawals:
