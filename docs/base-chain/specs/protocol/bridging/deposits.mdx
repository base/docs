...
[g-transaction-type]: ../../reference/glossary.mdx#transaction-type
[g-derivation]: ../../reference/glossary.mdx#L2-chain-derivation
[g-deposited]: ../../reference/glossary.mdx#deposited
...
[g-eoa]: ../../reference/glossary.mdx#eoa
...
The [Interop derivation spec](../consensus/derivation.mdx) introduces two additional kinds of system deposits,
...
- System configurables tied to the L1 block, see [System configuration specification](../consensus/derivation.mdx#system-configuration):
