...
| hint response      | 3               | read-only. Used to read the status of [pre-image hinting](index#hinting). |
| hint request       | 4               | write-only. Used to provide [pre-image hints](index#hinting)              |
| pre-image response | 5               | read-only. Used to [read pre-images](index#pre-image-communication).      |
| pre-image request  | 6               | write-only. Used to [request pre-images](index#pre-image-communication).  |
