...
description: "Specification of the AnchorStateRegistry contract, which stores verified dispute game results as anchor states for new dispute game instances."
---
...
> See [Fault Dispute Game](fault-dispute-game.mdx)
