---
title: "RPC"
description: "Specification of the rollup node RPC interface, including the optimism_outputAtBlock method for retrieving L2 output roots."
---

## L2 Output RPC method

The Rollup node has its own RPC method, `optimism_outputAtBlock` which returns a 32
byte hash corresponding to the [L2 output root](../fault-proof/proposer.mdx#l2-output-commitment-construction).
