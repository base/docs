...
[g-reorg]: ../../reference/glossary.mdx#re-organization
[g-rollup-driver]: ../../reference/glossary.mdx#rollup-driver
...
For a complete specification of the L2 block derivation, refer to the [L2 block derivation document](derivation.mdx).

The rollup node RPC surface is specified in the [RPC](rpc.mdx) document.
...
[`engine_signalSuperchainV1`](../execution/index.mdx#enginesignalsuperchainv1) call.
