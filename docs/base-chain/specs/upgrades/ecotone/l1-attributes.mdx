...
description: "L1 attributes transaction changes in the Ecotone upgrade, updating calldata format to support the new blob-based fee calculation model."
---
...
[ecotone-upgrade-txs]: derivation.mdx#network-upgrade-automation-transactions
...
[sys-config]: ../../protocol/consensus/derivation.mdx#system-configuration
...
[L1 Attributes Deposited Transaction Calldata](../../protocol/bridging/deposits.mdx#l1-attributes-deposited-transaction-calldata).
