...
[sys-config]: /specifications/base-protocol/consensus/derivation#system-configuration
...
[L1 Attributes Deposited Transaction Calldata](/specifications/base-protocol/bridging/deposits#l1-attributes-deposited-transaction-calldata).
