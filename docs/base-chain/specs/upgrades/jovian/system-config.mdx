---
title: "Jovian: System Config"
description: "SystemConfig changes in the Jovian upgrade, adding a minimum base fee configuration variable for the EIP-1559 fee market."
---
...
When the configuration is updated, a [`ConfigUpdate`](../../protocol/consensus/derivation.mdx#system-config-updates) event
...
Jovian adds a `uint16` configuration value to `SystemConfig` to control the [`daFootprintGasScalar`](derivation.mdx).
