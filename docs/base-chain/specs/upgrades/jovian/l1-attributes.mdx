...
description: "L1 attributes transaction changes in the Jovian upgrade, extending calldata to include the DA footprint gas scalar."
---
...
- If Jovian activates after genesis [`setL1BlockValuesIsthmus()`](../isthmus/l1-attributes.mdx) method must be used.
...
value from the [`SystemConfig`](../../protocol/consensus/derivation.mdx#system-configuration). If that value is `0`, then a default of `400` is set.
