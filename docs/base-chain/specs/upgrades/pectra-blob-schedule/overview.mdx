---
title: "Pectra Blob Schedule (Sepolia)"
description: "Overview of the Pectra Blob Schedule hardfork, an optional upgrade that delays adoption of Ethereum's increased blob count schedule on Base."
---
...
- [Derivation](/base-chain/specs/upgrades/pectra-blob-schedule/derivation)
