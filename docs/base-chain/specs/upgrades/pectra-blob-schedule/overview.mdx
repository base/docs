---
title: "Pectra Blob Schedule Overview"
description: "Overview of the Pectra Blob Schedule hardfork, an optional upgrade that delays adoption of the Prague blob base fee update fraction on Sepolia until a configured activation timestamp."
---
