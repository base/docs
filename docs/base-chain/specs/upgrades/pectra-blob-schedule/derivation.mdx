---
title: "Pectra Blob Schedule Derivation"
description: "Derivation rules for the Pectra Blob Schedule hardfork, controlling the blob base fee update fraction used in the L1 Attributes deposited transaction."
---
...
When setting the [L1 Attributes Deposited Transaction](../../reference/glossary#l1-attributes-deposited-transaction),
...
will have an inaccurate blob base fee in the [L1Block](../../protocol/execution/evm/predeploys#l1block) contract.
