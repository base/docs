...
description: "Derivation changes for the Pectra Blob Schedule hardfork, specifying how blob fee parameters are handled in L1 attributes transactions."
---
...
When setting the [L1 Attributes Deposited Transaction](../../reference/glossary.mdx#l1-attributes-deposited-transaction),
...
will have an inaccurate blob base fee in the [L1Block](../../protocol/execution/evm/predeploys.mdx#l1block) contract.
