...
- [Native Account Abstraction Reference](/base-chain/specs/upgrades/cobalt/eip-8130): chain details, client setup, transaction structure, account configuration, authenticators, and payers
