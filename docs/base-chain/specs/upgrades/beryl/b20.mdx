...
To deploy your first B20 token, see the [Launch a B20 token](/base-chain/network-information/b20-token-standard) quickstart.

<Warning>
[Verify the Activation Registry is enabled](/base-chain/network-information/b20-token-standard#verify-the-activation-registry-is-enabled) before attempting to deploy.
</Warning>
