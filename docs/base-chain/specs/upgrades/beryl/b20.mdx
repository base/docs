...
B20 is the Base ecosystem's own version of [ERC-20](https://eips.ethereum.org/EIPS/eip-20). It ships with a built-in compliance toolkit: transfer policies, freeze-and-seize, role-based access control, memos, and supply caps. For the normative protocol definition, see the [B20 specification](/base-chain/specs/upgrades/beryl/b20/specification). The full interface specs are also available in the [Base Standard Library](https://github.com/base/base-std/tree/main) repository.
