...
A court order targets one account. Freeze it so it can't send, then seize the balance with one call. Seizure only works on an account that is already frozen. Every other holder is untouched and the token keeps trading. See [transfer policies](/specs/cobalt/b20/overview#6-transfer-policies) and [burn and seize](/specs/cobalt/b20/overview#9-burn-and-seize) in the spec.
...
A new user shouldn't have to buy ETH first. With `permit`, they sign an approval offchain and your platform relays it. They start transacting with zero gas, and nonces stop signature replay. See [permit](/specs/cobalt/b20/overview#14-permit-erc-2612) in the spec.
...
<CardGroup cols={2}>
  ...
  <Card title="B20 native token standard" href="/specs/cobalt/b20/overview">
