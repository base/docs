...
<Note>
The walkthroughs on this page simulate [B20](/base-chain/specs/upgrades/beryl/b20) semantics entirely client-side. Nothing touches a chain or wallet.
</Note>
...
Stick with a plain ERC-20 if you need transfer logic B20 doesn't model (fee-on-transfer, custom hooks) or you're deploying off Base.
