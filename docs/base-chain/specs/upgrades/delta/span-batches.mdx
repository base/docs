...
[derivation]: ../../protocol/consensus/derivation.mdx
[channel-format]: ../../protocol/consensus/derivation.mdx#channel-format
[batch-format]: ../../protocol/consensus/derivation.mdx#batch-format
[frame-format]: ../../protocol/consensus/derivation.mdx#frame-format
[batch-queue]: ../../protocol/consensus/derivation.mdx#batch-queue
[batcher]: ../../protocol/batcher.mdx

## Introduction

Span-batch is a new batching spec that reduces overhead,
introduced in the [Delta](overview.mdx) network upgrade.
...
[Protocol Parameters table](../../protocol/consensus/derivation.mdx#protocol-parameters).
...
`MAX_SPAN_BATCH_ELEMENT_COUNT` is defined in [Protocol Parameters table](../../protocol/consensus/derivation.mdx#protocol-parameters).
...
- And for all transactions:
  - `drop` if the `batch.tx_datas` list contains a transaction
    ...
    - any transaction of a future type > 2 (note that
      [Isthmus adds support](../isthmus/derivation.mdx#activation)
