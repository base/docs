...
[prior EIP-1559 constants](../../protocol/execution/index.mdx#1559-parameters) must be used to populate `extraData` instead.
...
were [constants](../../protocol/execution/index.mdx#1559-parameters).
...
- if Holocene is not active in `parent_header.timestamp`, the [prior EIP-1559
  constants](../../protocol/execution/index.mdx#1559-parameters) are used. Note that `parent_header.extraData` is empty
