...
[block-validation]: ../../protocol/consensus/p2p.mdx#block-validation
[payload-attributes]: ../../protocol/consensus/derivation.mdx#building-individual-payload-attributes
[1559-params]: ../../protocol/execution/index.mdx#1559-parameters
[channel-reading]: ../../protocol/consensus/derivation.mdx#reading
[deposit-reading]: ../../protocol/bridging/deposits.mdx#deposit-receipt
[create2deployer]: ../../protocol/execution/evm/predeploys.mdx#create2deployer
