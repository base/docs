...
[gas-market]: ../../protocol/bridging/deposits.mdx#default-values
...
- `precompiles` reflects the active EVM precompile set for that fork. This includes the standard
  ...
  [precompiles specification](../../protocol/execution/evm/precompiles.mdx).
...
[predeploys specification](../../protocol/execution/evm/predeploys.mdx) are not serialized into
