...
description: "L1 attributes transaction changes in the Isthmus upgrade, extending calldata to include operator fee scalar and constant parameters."
---
...
- If Isthmus activates after genesis [`setL1BlockValuesEcotone()`](../ecotone/l1-attributes.mdx)
...
from the [`SystemConfig`](../../protocol/consensus/derivation.mdx#system-configuration):
