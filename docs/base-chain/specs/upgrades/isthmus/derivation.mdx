...
description: "Derivation changes in the Isthmus upgrade, specifying network upgrade automation transactions executed at hardfork activation."
---
...
[Span batches](../delta/span-batches.mdx) are a span of consecutive L2 blocks than are batched submitted.
...
[the Delta span batch spec](../delta/span-batches.mdx), adding a new transaction type:
