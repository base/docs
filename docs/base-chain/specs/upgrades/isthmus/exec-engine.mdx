...
[l2-to-l1-mp]: /specifications/base-protocol/execution/predeploys#L2ToL1MessagePasser
[output-root]: /specifications/reference/glossary#l2-output-root
...
because it is a [proxied predeploy](/specifications/base-protocol/execution/predeploys) -- from genesis it
...
`blobBaseFeeScalar` used in the [`L1Fee`](/specifications/base-protocol/execution/l2-execution-engine#ecotone-l1-cost-fee-changes-eip-4844-da).
