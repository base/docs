---
title: "Predeploys"
description: "Predeploy changes in the Fjord upgrade, adding FastLZ fee computation constants to the GasPriceOracle contract."
---
...
[Fjord L1-Cost fee changes (FastLZ estimator)](exec-engine.mdx#fjord-l1-cost-fee-changes-fastlz-estimator)
section.
...
The `getL1GasUsed` method is updated to take into account the improved [compression estimation](exec-engine.mdx#fees)
