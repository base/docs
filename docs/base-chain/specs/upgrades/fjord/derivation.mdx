...
The usage of `MAX_RLP_BYTES_PER_CHANNEL` is defined in [Channel Format](../../protocol/consensus/derivation.mdx#channel-format).
The usage of `MAX_CHANNEL_BANK_SIZE` is defined in [Channel Bank Pruning](../../protocol/consensus/derivation.mdx#pruning).
...
[legacy-channel-format]: ../../protocol/consensus/derivation.mdx#channel-format
