...
<CardGroup cols={2}>
  <Card title="B20 Token Standard" icon="coins" href="/base-chain/network-information/b20-token-standard">
    Base's native token standard for stablecoin, real-world asset, and long-tail issuers. An ERC-20 superset with compliance, reconciliation, and corporate actions built in.
  </Card>
