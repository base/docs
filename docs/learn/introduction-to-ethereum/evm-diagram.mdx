...
<Frame>
![Diagram showing the EVM execution model: transaction validation, context, opcode execution, and state modifications](/images/learn/ethereum-virtual-machine/evm-execution-basic.png)
</Frame>
...
<Frame>
![Detailed view of opcode execution, showing how opcodes interact with the stack, memory, and world state](/images/learn/ethereum-virtual-machine/opcode-execution.png)
</Frame>
...
<Frame>
![Diagram illustrating the EVM stack's LIFO structure and expandable memory array](/images/learn/ethereum-virtual-machine/evm-stack-memory.png)
</Frame>
...
<Frame>
![Comprehensive diagram of EVM architecture and execution context, featuring transaction origin, gas supply, program counter, and stack/memory interaction](/images/learn/ethereum-virtual-machine/evm-architecture-execution.png)
</Frame>
