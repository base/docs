...
<Frame>
![Screenshot of the Remix IDE editor pane showing the code editor and file tabs](/images/learn/introduction-to-solidity/editor-pane.png)
</Frame>
...
<Frame>
![Screenshot of the Remix IDE terminal showing transaction logs and debug output](/images/learn/introduction-to-solidity/remix-terminal.png)
</Frame>
