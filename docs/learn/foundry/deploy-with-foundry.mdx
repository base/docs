...
When verifying a contract with BaseScan, you need an API key. You can get your BaseScan API key from [Basescan](https://basescan.org/myapikey) after you sign up for an account.
