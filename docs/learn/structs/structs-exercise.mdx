...
<iframe
  src="https://682cef8eb764086a250fb541-zdfthryttt.chromatic.com/iframe.html?args=&id=components-cafeunittest--seven&viewMode=story&dark=true&hero=true"
  width="100%"
  height="auto"
/>

<Accordion title="⚠️ Spoiler Alert: Open only if tests fail">
