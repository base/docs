...
| Input arg         | Type    | Calldata bytes | Segment |0
| ----------------- | ------- | -------------- | ------- |
| {0x3db6be2b}      |         | 0-3            | n/a     |
...
value from the [`SystemConfig`](/specifications/base-protocol/consensus/derivation#system-configuration). If that value is `0`, then a default of `400` is set.
