...
<Update label="TBD" tags={["Planning"]}>
## Denim

Denim introduces native account abstraction with EIP-8130, allowing smart accounts to send ordinary transactions with no bundlers or relays.

- **Base Sepolia:** TBD
- **Base Mainnet:** TBD

<a className="view-features-btn" href="/upgrades/denim/eip-8130">View Features</a>
</Update>

<Update label="October 2026" tags={["Planning"]}>
## Cobalt

Cobalt introduces native blocks at a 200ms cadence, improves the B20 token standard, and introduces dynamic node upgrades.

- **Base Sepolia:** Targeting late October 2026
- **Base Mainnet:** Targeting late October 2026
