...
- **Base Mainnet:** Targeting October 2026

<a className="view-features-btn" href="/upgrades/denim/overview">View Features</a>
</Update>

<Update label="September 30, 2026" tags={["Planning"]}>
## Cobalt

Cobalt improves the B20 token standard, adds validity transactions, introduces dynamic node upgrades (metrics-only on Mainnet), and migrates Base to a Trusted Execution Environment.

- **Base Sepolia:** Activated September 23, 2026
- **Base Mainnet:** Targeting September 30, 2026
