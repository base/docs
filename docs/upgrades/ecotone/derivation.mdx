---
title: "Derivation"
description: "Derivation changes in the Ecotone upgrade, extending the retrieval stage to support EIP-4844 blobs as an additional data availability source."
---
...
```python Blob Encoding Pseudocode lines wrap expandable
