---
title: "Canyon"
description: "Overview of the Canyon hardfork, bringing Ethereum Shanghai EIPs (EIP-3651, EIP-3855, EIP-3860) to the Base execution layer."
---
...
[block-validation]: /specifications/base-protocol/consensus/p2p#block-validation
[payload-attributes]: /specifications/base-protocol/consensus/derivation#building-individual-payload-attributes
[1559-params]: /specifications/base-protocol/execution/l2-execution-engine#1559-parameters
[channel-reading]: /specifications/base-protocol/consensus/derivation#reading
[deposit-reading]: /specifications/base-protocol/bridging/deposits#deposit-receipt
[create2deployer]: /specifications/base-protocol/execution/predeploys#create2deployer
