...
| TEE Registration Migration | Replace ZK-based Nitro attestation proofs with checked P-384 hints for TEE signer registration. | [Registrar specification](/specifications/base-protocol/proofs/registrar) | Q3 2026 |
