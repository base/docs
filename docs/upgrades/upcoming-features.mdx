...
| TEE Registration Migration | Speed up the registration of new TEE signers by replacing external ZK proving with P-384 hints verified onchain. | [Registrar specification](/specifications/base-protocol/proofs/registrar) | Q3 2026 |
