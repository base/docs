---
title: "Span-Batches"
description: "Specification of span batches introduced in Delta, a new batch format that compresses sequences of L2 blocks for more efficient L1 data posting."
---

[g-deposit-tx-type]: /specifications/reference/glossary#deposited-transaction-type
[derivation]: /specifications/base-protocol/consensus/derivation
[channel-format]: /specifications/base-protocol/consensus/derivation#channel-format
[batch-format]: /specifications/base-protocol/consensus/derivation#batch-format
[frame-format]: /specifications/base-protocol/consensus/derivation#frame-format
[batch-queue]: /specifications/base-protocol/consensus/derivation#batch-queue
...
[Protocol Parameters table](/specifications/base-protocol/consensus/derivation#protocol-parameters).
...
`MAX_SPAN_BATCH_ELEMENT_COUNT` is defined in [Protocol Parameters table](/specifications/base-protocol/consensus/derivation#protocol-parameters).
