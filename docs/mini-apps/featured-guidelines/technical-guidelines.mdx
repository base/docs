...
<Note>
  Validate your manifest using our preview tools at <a href="https://base.dev/preview" target="_blank" rel="noopener noreferrer">base.dev/preview</a>.
</Note>
...
<Note>
  Claim free gas credits on <a href="https://base.dev" target="_blank" rel="noopener noreferrer">base.dev</a>.
</Note>
