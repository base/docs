...
- Personalize instantly with [`context`](/mini-apps/core-concepts/context) of the user's profile to instantly personalize
...
<CardGroup cols={3}>
  ...
  <Card title="MiniKit Overview" icon="cog" href="/mini-apps/introduction/overview" />
  <Card title="useAuthenticate" icon="book-open" href="/mini-apps/core-concepts/authentication" />
</CardGroup>
