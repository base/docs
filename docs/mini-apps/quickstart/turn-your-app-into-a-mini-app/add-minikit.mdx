...
<CardGroup cols={2}>
  <Card title="Configure environment" icon="cog" href="/mini-apps/quickstart/turn-your-app-into-a-mini-app/configure-environment">
    Add required and optional env vars
  </Card>
  <Card title="Create manifest" icon="id-badge" href="/mini-apps/quickstart/turn-your-app-into-a-mini-app/manifest-cli">
