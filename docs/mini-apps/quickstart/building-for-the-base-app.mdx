...
- Whatâ€™s the **one thing** my app does really well?
...
- Have **low friction onboarding** â€” avoid:
...
Weâ€™re especially excited about mini apps that make group chats more fun, functional, or rewarding â€” from games with onchain buy-ins, to tools like dinner-bill splitting with USDC.
</Step>
</Steps>
