...
<Card title="Add MiniKit to your app" icon="puzzle-piece" href="/mini-apps/quickstart/turn-your-app-into-a-mini-app/add-minikit">
Wrap your app with MiniKitProvider and initialize the context
</Card>
