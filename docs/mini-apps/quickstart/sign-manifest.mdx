...
For NextJS apps, this is done creating a file in the following directory: `app/.well-known/farcaster.json/route.ts`
...
<Tabs>
  <Tab title="Base Build" icon="star">
    ...
    You should now see three green check marks indicating successfull signing.
  ...
  <Tab title="Farcaster">
    ...
    You should now see green check marks indicating successfull signing.
