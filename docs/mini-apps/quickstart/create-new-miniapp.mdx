...
Now that you have a public domain for your application, you are ready to associate your mini app with your Farcaster account.
    ...
    <img 
      ...
      alt="Screenshot of the Account Association tool in Base Build showing the option to sign a manifest"
      height="300"
...
<img 
  ...
  alt="Screenshot of the Base app interface showing how to publish a mini app by creating a post"
  height="300"
  className="rounded-lg"
/>
</Step>
