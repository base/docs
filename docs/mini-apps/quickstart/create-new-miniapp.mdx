...
See [Farcaster docs](https://miniapps.farcaster.xyz/docs/guides/publishing#define-your-application-configuration) for the mapping of what each frame property is responsible for.
</Step>
