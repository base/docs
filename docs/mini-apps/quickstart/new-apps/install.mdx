...
<Tip>
These docs are LLM‑friendly—reference llms.txt in your editor to streamline builds and prompts. Just click to copy page as a LLM.txt file from the drop down menu at the start of this page.
</Tip>
