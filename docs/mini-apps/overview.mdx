...
Mini apps built with either the Farcaster SDK or MiniKit both work seamlessly in the Base app. Choose the framework that best fits your development preferences
</Tip>
