...
<Note>
Existing web applications can be converted into Mini Apps. Learn how to [integrate your existing app](/mini-apps/quickstart/turn-your-app-into-a-mini-app/install) with our helpful guide.
</Note>
...
<Step title="Build your Mini App">
  Use [MiniKit](/mini-apps/quickstart/build-a-mini-app/install) or the [Farcaster SDK](https://miniapps.farcaster.xyz/docs/getting-started) to create your application.
</Step>
...
<CardGroup cols={2}>
<Card title="Quick Start Guide" icon="rocket" href="/mini-apps/quickstart/build-a-mini-app/install">
  Get started with MiniKit and build your first Mini App in minutes.
</Card>

<Card title="Existing App Integration" icon="code" href="/mini-apps/quickstart/turn-your-app-into-a-mini-app/install">
