...
curl -X POST "https://www.base.dev/v1/notifications/send" \
  ...
  -d '{
    ...
    "wallet_addresses": [
      ...
      "0x4e2bC8463190fBa0C5bF5921a98552f4728E3e9f"
    ],
    "title": "New reward available",
    "message": "You have a reward waiting. Tap to claim it.",
    "target_path": "/rewards"
...
```json Response
{
  ...
  "results": [
    {
      "walletAddress": "0xc0c3132DFc4929bb6F68FA76B8fB379fF8c5bE74",
      "sent": true
    },
    {
      "walletAddress": "0x4e2bC8463190fBa0C5bF5921a98552f4728E3e9f",
      "sent": false,
