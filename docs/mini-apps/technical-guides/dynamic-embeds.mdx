...
```tsx app/api/og/[username]/route.tsx
...
```tsx app/share/[username]/page.tsx
...
curl http://localhost:3000/share/testuser | grep "fc:frame"
```

Click the share button in your app to test the full experience.
</Step>
</Steps>
