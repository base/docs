...
Neynar's solution provides you with:

- Fully managed notification infrastructure (tokens, permissions, batching)
...
Neynar will manage all [notification events](/mini-apps/core-concepts/notifications#events)
