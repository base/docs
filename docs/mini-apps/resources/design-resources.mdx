...
* **[shots.so](https://shots.so/)** - Clean, customizable mockups for screenshots and social media.
* **[Mockey.ai](https://mockey.ai/)** - Extensive library of the latest mobile and desktop device frames.
* **[Previewed](https://previewed.app/)** - Advanced 3D device mockups and cinematic app presentations.
...
* **[Phosphor Icons](https://phosphoricons.com/)** - Flexible icon family for interfaces and diagrams
* **[Radix Icons](https://icons.radix-ui.com/)** - A crisp set of 15x15 icons for professional UIs
