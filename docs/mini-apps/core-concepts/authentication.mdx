...
```
When a user authenticates, the Quick Auth Server verifies their signature and issues a JWT. The Quick Auth client then verifies this JWT (default server: `https://auth.farcaster.xyz`).
