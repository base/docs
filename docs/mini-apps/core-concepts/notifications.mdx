...
<Steps>
  ...
  <Warning>
    If you encounter a "Failed to add mini app" error, your webhook may be taking too long to respond. Webhooks must respond within 5 seconds to avoid timeouts from the Base app.
  </Warning>
