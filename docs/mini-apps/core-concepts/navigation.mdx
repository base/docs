...
### Deeplink Protocol
Use the `cbwallet://` deeplink protocol to launch your mini app directly from external sources like websites, QR codes, or other applications.

```HTML
<a href="cbwallet://miniapp?url=[YOUR_MINI_APP]">
  Launch Mini App
</a>
```