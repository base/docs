...
Version of the embed. Use `"next"` — this is the current recommended version for Mini Apps. (`"1"` is a legacy value and should not be used.)
</ParamField>
...
Action type. Must be `"launch_miniapp"`.
</ParamField>
...
Splash screen image URL. Must be 200x200 pixels. Maximum 1024 characters. Defaults to manifest splash image. Example: `https://example.com/images/splash.png`
</ParamField>
