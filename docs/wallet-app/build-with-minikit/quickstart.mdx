...
1. **Farcaster Account**: Create an account on [Farcaster](https://farcaster.com/) to test and deploy your Mini Apps.
...
4. Visit [Farcaster Frames Developer Tools](https://farcaster.com/~/developers/frames)
...
2. Visit [Farcaster Frames Developer Tools](https://farcaster.com/~/developers/frames) on web or mobile
...
<CardGroup cols={2}>
<Card title="Explore MiniKit Overview" icon="book-open" href="/builderkits/minikit/overview">
Learn more about MiniKit features and capabilities
</Card>

<Card title="Social Patterns Guide" icon="users" href="/builderkits/minikit/thinking-social">
