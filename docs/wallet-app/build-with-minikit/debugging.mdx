...
<Card title="Embed Debugging" icon="bug" href="https://warpcast.com/~/developers/mini-apps/embed">
...
<Steps>
<Step title="Open Warpcast Mobile App">
...
<Card title="Farcaster Debugging" icon="magnifying-glass" href="https://warpcast.com/~/developers/frames">
