...
<Card title="Embed Debugging" icon="bug" href="https://farcaster.com/~/developers/mini-apps/embed">
...
<Card title="Farcaster Debugging" icon="magnifying-glass" href="https://farcaster.com/~/developers/frames">
