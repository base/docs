...
<Warning>
This guide assumes you want to add MiniKit to an existing application. For new projects, use the [MiniKit CLI](/builderkits/minikit/quickstart) for automatic setup.
</Warning>
...
**Manifest Validator:**
```
https://farcaster.com/~/developers/mini-apps/manifest
```
