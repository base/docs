...
<Card title="MiniKit Documentation" icon="book" href="/builderkits/minikit/">
Complete MiniKit guide and reference
</Card>
...
<Card title="Component Library" icon="puzzle-piece" href="https://onchainkit.xyz/">
OnchainKit components for Web3 features
</Card>
</CardGroup>
