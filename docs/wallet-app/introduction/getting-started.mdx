...
<Card title="MiniKit" icon="book" href="https://docs.base.org/builderkits/minikit/overview">
...
<Card title="Debug Guide" icon="alert-triangle" href="https://docs.base.org/builderkits/minikit/debugging">
