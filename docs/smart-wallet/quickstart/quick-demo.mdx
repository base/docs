...
This option uses the OnchainKit [Wallet component](/onchainkit/wallet/wallet). It is perfect for quickly experiencing Smart Wallet functionality with minimal setup.
...
If you are looking for a more in depth understanding of Smart Wallet, jump ahead to the [Explore More Features](/smart-wallet/quickstart#explore-more-features) section.
