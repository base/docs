...
Profiles allow developers to request personal information from Base Account users during a transaction. This is useful for applications that need:
...
Base Account handles the collection of this information and it is left to the developer
...
When you send a request for a transaction to Base Account,
