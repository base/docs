...
1. Smart Wallet relies on [passkeys](/smart-wallet/concepts/features/built-in/passkeys), stored on users' devices, which can be used on our website (keys.coinbase.com) and [mobile app](https://www.coinbase.com/wallet).
