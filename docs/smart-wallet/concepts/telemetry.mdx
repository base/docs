...
By default, telemetry collection follows an opt-out model. If you'd like to disable telemetry in your Smart Wallet implementation, you can configure it during SDK initialization:
