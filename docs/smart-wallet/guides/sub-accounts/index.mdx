---
title: 'Creating Sub Accounts with Base Account'
description: 'Learn how to create and manage Sub Accounts using Base Account'
---
...
- Lets users log in with their Base Account
...
1. [Project Setup](/smart-wallet/guides/sub-accounts/setup) - Learn how to set up a NextJS project with Wagmi and configure Base Account Sub Accounts. This guide covers:

   - Creating a new NextJS+Wagmi project
   - Configuring Base Account with development environment settings
   - Setting up Spend Permissions for native ETH
   - Creating a basic wallet connection interface

2. [Using Sub Accounts](/smart-wallet/guides/sub-accounts/using-sub-accounts) - Explore how to interact with Sub Accounts in your application. This guide demonstrates:
...
3. [Using Sub Accounts with OnchainKit](/smart-wallet/guides/sub-accounts/add-sub-accounts-to-onchainkit) - Learn how to use Sub Accounts with OnchainKit. This guide demonstrates:
