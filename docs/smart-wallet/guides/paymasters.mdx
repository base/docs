...
The code below is also in our [Wagmi Base Account template](https://github.com/wilsoncusack/wagmi-scw/).

## Skip ahead and clone the template

If you are looking for a complete example, you can skip the steps below and clone the [Wagmi Base Account template](https://github.com/wilsoncusack/wagmi-scw/). Simply open a terminal and run:
...
<Frame>
  ...
  **You can also choose to create custom advanced policies !**
  ...
  This section shows you how to create Wagmi and Viem clients to interact with Base Account using
  ...
  **About The Hooks Used Above**
  ...
  It is recommended to have a fallback function if your app supports wallets other than Base Account.
