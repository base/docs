---
title: 'Smart Wallet Profiles Integration in Onchain Vibes Store'
...
Onchain Vibes Store demonstrates how to use **Smart Wallet Profiles**
...
The main logic lives in [`src/components/CheckoutButton.tsx`](./src/components/CheckoutButton.tsx):
...
The callback API is implemented in [`src/api/data-validation/route.ts`](./src/api/data-validation/route.ts):
...
- [Profiles Guide](https://docs.base.org/identity/smart-wallet/guides/profiles)
- [Profiles Reference](https://docs.base.org/identity/smart-wallet/concepts/features/optional/profiles)
- [Coinbase Smart Wallet Docs](https://docs.base.org/identity/smart-wallet/)
- [Wagmi Docs](https://wagmi.sh/)

---

This integration makes onchain commerce seamless and privacy-first, with user-controlled data sharing and validation built in.
