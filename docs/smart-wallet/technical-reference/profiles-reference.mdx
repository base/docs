...
The [Profiles feature](/smart-wallet/concepts/features/optional/profiles) allows developers to request personal information from Base Account users during a
