...
The [Profiles feature](/smart-wallet/concepts/features/optional/profiles) allows developers to request personal information from Smart Wallet users during a
...
If you are looking for a guide on how to implement Profiles, please see the [Profiles guide](/smart-wallet/guides/profiles).
...
To request profile data, include the `dataCallback` capability in your [`wallet_sendCalls`](/smart-wallet/technical-reference/sdk/CoinbaseWalletProvider/wallet_sendCalls) request:
