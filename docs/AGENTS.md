...
|Build on Base/Accept Payments/Set Up the Protocol:build-on-base/accept-payments/use-commerce-payments-protocol,build-on-base/accept-payments/configure-a-payment,build-on-base/accept-payments/choose-a-token-collector
|Build on Base/Accept Payments/Payment Lifecycle:build-on-base/accept-payments/charge-a-payment,build-on-base/accept-payments/authorize-a-payment,build-on-base/accept-payments/capture-an-authorization,build-on-base/accept-payments/capture-a-partial-amount,build-on-base/accept-payments/void-an-authorization,build-on-base/accept-payments/reclaim-an-authorization,build-on-base/accept-payments/refund-a-payment
|Build on Base/Accept Payments/Operations:build-on-base/accept-payments/verify-a-payment,build-on-base/accept-payments/watch-for-payments,build-on-base/accept-payments/reconcile-payments
