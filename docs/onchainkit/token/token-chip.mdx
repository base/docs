...
<iframe
  src="https://682cef8eb764086a250fb541-zdfthryttt.chromatic.com/iframe.html?args=&id=onchainkit-token-chip--default&viewMode=story&dark=true&hero=true"
  width="100%"
  height="auto"
/>
{/* <App>
...
[`TokenChipReact`](/onchainkit/token/types#tokenchipreact)
