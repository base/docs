...
- Check out the [component documentation](/components) to see what's available
- Look at [example templates](/templates) for inspiration
- Read the [configuration guide](/config) for advanced setup options
