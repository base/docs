...
```tsx
<WalletDropdownFundLink openIn="tab" target="_blank" rel="noopener noreferrer" /> // [!code focus]
```
...
{/* <WalletComponents>
  <Wallet>
    ...
    <WalletDropdown>
      <WalletDropdownFundLink openIn="tab" target="_blank" rel="noopener noreferrer" />
      <WalletDropdownDisconnect />
    </WalletDropdown>
  </Wallet>
</WalletComponents> */}
...
```tsx
<WalletDropdownFundLink fundingUrl={"https://base.org"} openIn="tab" target="_blank" rel="noopener noreferrer" /> // [!code focus]
```
...
{/* <WalletComponents>
  <Wallet>
    ...
    <WalletDropdown>
      <WalletDropdownFundLink fundingUrl={"https://base.org"} openIn="tab" target="_blank" rel="noopener noreferrer" />
      <WalletDropdownDisconnect />
    </WalletDropdown>
  </Wallet>
</WalletComponents> */}
