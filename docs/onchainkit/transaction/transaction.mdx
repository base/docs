...
<Steps>
  ...
  <Frame>
  <img
    alt="Screenshot of the Coinbase Developer Platform interface showing where to find the Paymaster and Bundler endpoint URL"
...
<div className="flex flex-col max-w-[648px] gap-6">
  <img
    ...
    alt="Diagram breaking down the anatomy of the Transaction component, showing the button, sponsor info, and status labels"
