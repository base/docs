...
You can find the full set of Base Assets are on the [Base Brand Assets Figma File](https://www.figma.com/design/L8K5httaDFjiAqfWrChMFi/Sign-in-with-Base---Base-Pay%E2%80%94Media-Kit?node-id=0-1&p=f&t=5766QEX963be2lrj-0).
