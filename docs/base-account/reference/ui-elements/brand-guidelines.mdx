...
<div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
  <img src="/images/base-account/SIWB-Dark-Mode.jpg" alt="Sign in with Base button displayed in dark mode with white text on a blue square" style={{ width: '1000px', height: 'auto', marginRight: '1rem' }} />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
  <img src="/images/base-account/SIWB-Light-Mode.jpg" alt="Sign in with Base button displayed in light mode with blue text on a white background" style={{ width: '1000px', height: 'auto', marginRight: '1rem' }} />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
  <img src="/images/base-account/SIWB-Examples.jpg" alt="Examples of proper and improper usage of the Sign in with Base button" style={{ width: '600px', height: 'auto' }} />
</div>
  ...
  <button
    ...
    >
      <img
        ...
        alt="Base Pay button with blue logo on white background"
        style={{
          height: '20px',
          width: 'auto'
        }}
  ...
  <button
    ...
    >
      <img
        ...
        alt="Base Pay button with white logo on blue background"
        style={{
          height: '20px',
          width: 'auto'
        }}
...
<div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
  <img src="/images/base-account/BasePay-Buttons.jpg" alt="Base Pay button designs in light and dark modes" style={{ width: '500px', height: 'auto' }} />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
  <img src="/images/base-account/BasePay-Examples.jpg" alt="Examples of proper and improper usage of the Base Pay button" style={{ width: '600px', height: 'auto' }} />
</div>
