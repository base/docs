...
<Info>
The `subscription.prepareCharge` function prepares the necessary transaction calls to charge a subscription. It returns the call data needed to execute the charge through `wallet_sendCalls`. This gives you full control over when and how to execute subscription charges.
</Info>
