...
| ---- | ------- | ----------- |
| 4001 | User rejected payment | User denied the payment request |
| 4100 | Invalid amount format | The amount parameter is not a valid number string |
| 4200 | Invalid address format | The recipient address is not a valid Ethereum address |
| 4300 | Insufficient balance | User does not have enough USDC to complete the payment |
| 4400 | Network error | Unable to connect to the Base network |
