...
Custom wallet name for the CDP smart wallet. Default: "subscription owner"
</ParamField>
...
// Use a custom wallet name for organization
const result = await base.subscription.charge({
  id: subscriptionId,
  amount: '5.00',
  walletName: 'premium-subscriptions-wallet',
  testnet: false
});
```
</RequestExample>
