...
The type of sub account to create. Can be "create", "deployed" or "undeployed".
</ParamField>
...
The address of the deployed account to add as a sub account. (required for "deployed" and "undeployed" types).
</ParamField>

<ParamField body="factory" type="string">
The factory contract address (optional, only for "undeployed" type).
</ParamField>

<ParamField body="factoryData" type="string">
Factory deployment data (optional, only for "undeployed" type).
</ParamField>

<ParamField body="chainId" type="string">
The chain ID that the account is deployed on. (optional, only for "undeployed" type).
</ParamField>
</Expandable>
</ParamField>
...
The chain ID that the account is deployed on (optional).
</ResponseField>
...
```json Undeployed Request
{
  ...
  "params": [{
    "account": {
      "type": "undeployed",
      "address": "0x1234567890123456789012345678901234567890",
      "factory": "0xabcdef0123456789...",
      "factoryData": "0xabcdef0123456789...",
      "chainId": "0x2105"
    }
  }]
}
