...
The factory contract address (optional, used for "undeployed" type).
</ParamField>

<ParamField body="factoryData" type="string">
Factory deployment data (optional, used for "undeployed" type).
</ParamField>

<ParamField body="chainId" type="string">
The chain ID that the account is deployed on. (optional, used for "deployed" type).
</ParamField>
</Expandable>
</ParamField>
...
```json Undeployed Request
{
  ...
  "params": [{
    "account": {
      "type": "undeployed",
      "factory": "0xabcdefabcdefabcdefabcdefabcdefabcdefabcdef",
