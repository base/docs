...
1. Get test USDC from the <a href="https://faucet.circle.com" target="_blank" rel="noopener noreferrer">Circle Faucet</a> (select "Base Sepolia").  
2. Pass <code>testnet: true</code> in your <code>pay()</code> and <code>getPaymentStatus()</code> calls.  
3. Use <a href="https://sepolia.basescan.org" target="_blank" rel="noopener noreferrer">Sepolia BaseScan</a> to watch the transaction.
