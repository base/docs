...
<div style={{ display: 'flex', justifyContent: 'center'}}>
  <img src="/images/base-account/BasePayFinal.gif" alt="Animation showing the user experience of the Base Pay popup during a transaction" style={{ width: '300px', height: 'auto' }} />
</div>
