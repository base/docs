...
<<<<<<< HEAD
description: 'A step-by-step guide for Base App users to transfer their Basenames to new wallet addresses.'
=======
description: 'Step-by-step guide for Base App users to transfer their Basenames to new wallet addresses.'
>>>>>>> 05ba46d6478b8df0c5976dffa95ec198038e5c8c
---
...
If you have an existing Basename that you'd like to use, you'll need to transfer it to your new wallet address. We do not allow import or linking of pre-existing Basenames without transfer at this time.
...
<Warning>
  **Make sure to use the Basenames UI to send Basenames properly, sending on platforms like OpenSea
...
<Info>
  **For the new owner to use the basename they will need to confirm by first setting it as their primary name.**
</Info>
