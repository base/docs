...
5. **Complete the Transfer**
   - Sign all **three transactions** in sequence:
...
When you complete all three transactions, you're transferring:
...
- **Change address resolution**: Updates the Basename to resolve to the new address
...
- You're completing all three transactions in the sequence
