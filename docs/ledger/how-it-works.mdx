...
description: "The lifecycle of a payment on a Base Ledger: funds enter through the Portal contract, move privately within the ledger, and exit back to Base, with the operator authorizing each step."
---
