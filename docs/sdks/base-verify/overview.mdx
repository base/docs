...
<CardGroup cols={2}>
  <Card title="Authenticate Users" icon="key" href="https://docs.cdp.coinbase.com/coinbase-wallet/guides/authenticate-users">
    Connect Coinbase Wallet and authenticate users.
  </Card>
  <Card title="Sign and Verify Typed Data" icon="signature" href="https://docs.cdp.coinbase.com/coinbase-wallet/guides/sign-and-verify-typed-data">
