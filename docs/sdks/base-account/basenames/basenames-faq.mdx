...
If you're a builder looking to integrate Basenames into your app, follow the [Basenames + Wagmi tutorial](/sdks/base-account/framework-integrations/wagmi/basenames) to get started. If you have ideas for new features or badges that you'd like to integrate with Basenames, we'd love to [hear from you](https://app.deform.cc/form/b9c1c39f-f238-459e-a765-5093ca638075/?page_number=0).
