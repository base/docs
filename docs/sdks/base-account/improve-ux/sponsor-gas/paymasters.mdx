...
<Steps>
  ...
  We'll use [Coinbase Developer Platform](https://www.coinbase.com/developer-platform) as a Paymaster service provider. CDP provides free credits when you sign up.
