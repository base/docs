...
We recommend the [Coinbase Developer Platform](https://www.coinbase.com/developer-platform) paymaster because it supports Base Account ERC20 token gas payments out of the box. CDP also provides free credits when you sign up.
...
```js Top Up Paymaster Allowance lines wrap expandable
...
```json Success Response lines wrap expandable
{
  "id": 1,
  "jsonrpc": "2.0",
  "result": {
...
```json Rejection Response lines wrap expandable
{
  "id": 1,
  "jsonrpc": "2.0",
  "error": {
...
```json Response lines wrap expandable
{
  "id": 1,
  "jsonrpc": "2.0",
  "result": {
