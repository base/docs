...
```tsx src/wagmi.ts lines wrap expandable
...
```tsx src/pages/_app.tsx lines wrap expandable
...
```tsx src/pages/index.tsx lines wrap expandable
...
<div style={{ display: 'flex', justifyContent: 'center'}}>
  <img src="/images/sdks/base-account/RainbowKitWalletWindow.png" alt="RainbowKit Wallet Window" style={{ width: '600px', height: 'auto' }} />
</div>
...
When implemented, this is what it will look like:
<div style={{ display: 'flex', justifyContent: 'center'}}>
  <img src="/images/sdks/base-account/BaseAccountButton.png" alt="Base Account Button" style={{ width: '200px', height: 'auto' }} />
</div>
...
```tsx Profile.tsx lines wrap expandable
...
```tsx NetworkSwitcher.tsx lines wrap expandable
...
<CardGroup cols={2}>
  <Card title="Explore Base Account Features" icon="code" href="/sdks/base-account/overview">
