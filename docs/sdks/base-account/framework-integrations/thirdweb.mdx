...
```tsx Add to Layout (src/app/layout.tsx) lines wrap expandable
...
```tsx src/app/page.tsx lines wrap expandable
"use client";
...
<div style={{ display: 'flex', justifyContent: 'center'}}>
  <img src="/images/sdks/base-account/Thirdweb-Base-Account.png" alt="Base × Thirdweb Demo" style={{ width: '600px', height: 'auto' }} />
</div>
...
```tsx Wallet Options lines wrap expandable
// Email only
...
```tsx Theme Options lines wrap expandable
