...
```typescript config/wagmi.ts lines wrap expandable
// config/wagmi.ts
...
```typescript app/layout.tsx lines wrap expandable
// app/layout.tsx
'use client';
...
```typescript hooks/useUnifiedAuth.ts lines wrap expandable
...
```typescript components/WalletAuthButton.tsx lines wrap expandable
...
```typescript components/SendTransaction.tsx lines wrap expandable
...
```typescript app/page.tsx lines wrap expandable
// app/page.tsx
'use client';
...
- [Base Account Wagmi Setup](/sdks/base-account/framework-integrations/wagmi/setup)
