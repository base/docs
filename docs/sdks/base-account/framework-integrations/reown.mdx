...
```typescript src/config/index.ts lines wrap expandable
...
```tsx src/context/index.tsx lines wrap expandable
'use client'
...
```tsx src/app/layout.tsx lines wrap expandable
...
<div style={{ display: 'flex', justifyContent: 'center'}}>
  <img src="/images/sdks/base-account/reown-base-account.png" alt="Reown AppKit with Base Account" style={{ width: '600px', height: 'auto' }} />
</div>
