...
Base Pay doesn't require any special Wagmi integration. Simply follow the [Accept Payments guide](/build-on-base/accept-payments/from-humans) - all the code examples work exactly the same in your Wagmi app.
...
For complete implementation details, examples, and advanced features like collecting user information, see the main [Accept Payments guide](/build-on-base/accept-payments/from-humans).
