...
Base Pay doesn't require any special Wagmi integration. Simply follow the [Accept Payments guide](/build-on-base/accept-payments/request-a-payment) - all the code examples work exactly the same in your Wagmi app.
...
```tsx CheckoutButton.tsx lines wrap expandable
...
For complete implementation details, examples, and advanced features like collecting user information, see the main [Accept Payments guide](/build-on-base/accept-payments/request-a-payment).
