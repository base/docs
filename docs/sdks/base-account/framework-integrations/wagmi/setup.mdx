...
```typescript app/wagmi.ts lines wrap expandable
...
<CodeGroup>
```tsx app/providers.tsx lines wrap expandable
'use client'
...
```tsx app/layout.tsx lines wrap expandable
'use client'
...
<CodeGroup>
```tsx app/components/SignInWithBase.tsx lines wrap expandable
"use client";
...
```
```tsx app/page.tsx lines wrap expandable
"use client";
...
<div style={{ display: 'flex', justifyContent: 'center'}}>
  <img src="/images/sdks/base-account/wagmi-siwb.png" alt="Wagmi Setup" style={{ width: '500px', height: 'auto' }} />
</div>
...
- [Connect users with Sign in with Base](/sdks/base-account/framework-integrations/wagmi/sign-in-with-base)
- [Access the Base Account provider](/sdks/base-account/framework-integrations/wagmi/other-use-cases)
