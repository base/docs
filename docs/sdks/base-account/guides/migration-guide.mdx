...
<div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
  <img src="/images/sdks/base-account/CreateWalletFlow.png" alt="Create Wallet Flow" style={{ width: '300px', height: 'auto' }} />
</div>
...
For more information please refer to the [Quickstart](/sdks/base-account/quickstart/web) guide.

If you're using a third party library, you can follow the [Wagmi](/sdks/base-account/framework-integrations/wagmi/setup), [RainbowKit](/sdks/base-account/framework-integrations/rainbowkit) or [Privy](/sdks/base-account/framework-integrations/privy/setup) guides.
