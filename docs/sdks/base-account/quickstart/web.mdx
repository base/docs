...
```html index.html lines wrap expandable
<script type="module">
  import {
...
- **[Add Sign In With Base Button](/sdks/base-account/reference/ui-elements/sign-in-with-base-button)** – implement full SIWE authentication with backend verification
- **[Add Base Pay Button](/sdks/base-account/reference/ui-elements/base-pay-button)** – collect user information during payment flow
