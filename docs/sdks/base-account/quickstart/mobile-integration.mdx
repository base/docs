...
description: "Integrate Base Account into a React Native mobile app with sign-in and USDC payments."
---
...
```tsx App.tsx lines wrap expandable
...
```ts config.ts lines wrap expandable
import {
