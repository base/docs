...
<ParamField body="capabilities" type="Record<string, unknown>">
  Optional wallet capabilities to include in the request. See [capabilities documentation](/sdks/base-account/reference/core/capabilities/overview).
</ParamField>
</Expandable>
</ParamField>
...
```typescript Encode an ERC20 Transfer lines wrap expandable
import { encodeProlink } from '@base-org/account';
...
```typescript Encode a Native Transfer lines wrap expandable
...
```typescript Encode with Capabilities lines wrap expandable
...
```typescript Encode a Spend Permission lines wrap expandable
...
```typescript Encode Generic JSON-RPC lines wrap expandable
...
```typescript Batch Multiple Calls lines wrap expandable
...
<CardGroup cols={2}>
  <Card title="decodeProlink" icon="expand" href="/sdks/base-account/reference/prolink-utilities/decodeProlink">
    Decode a prolink payload back to a JSON-RPC request
  </Card>
  <Card title="wallet_sendCalls" icon="paper-plane" href="/sdks/base-account/reference/core/provider-rpc-methods/wallet_sendCalls">
    Learn about transaction batching
  </Card>
  <Card title="Capabilities" icon="sliders" href="/sdks/base-account/reference/core/capabilities/overview">
