...
<RequestExample>
```typescript Check permission status lines wrap expandable
...
<ResponseExample>
```typescript Example response lines wrap expandable
{
