...
<CardGroup cols={3}>
<Card title="Accept Recurring Payments Guide" icon="book" href="/build-on-base/agentic-payments/accept-subscriptions">
Learn how to implement recurring payments with Base Pay
</Card>

<Card title="One-Time Payments Guide" icon="book" href="/build-on-base/agentic-payments/accept-a-payment">
