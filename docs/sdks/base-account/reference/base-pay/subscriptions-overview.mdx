...
```typescript Type Definitions lines wrap expandable
...
<CardGroup cols={3}>
<Card title="Subscribe() Reference" icon="book" href="/sdks/base-account/reference/base-pay/subscribe">
Learn how to implement recurring payments with Base Pay
</Card>

<Card title="One-Time Payments Guide" icon="book" href="/build-on-base/accept-payments/request-a-payment">
