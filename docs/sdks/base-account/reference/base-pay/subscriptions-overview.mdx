...
<Card title="getOrCreateSubscriptionOwnerWallet" icon="wallet" href="/sdks/base-account/reference/base-pay/getOrCreateSubscriptionOwnerWallet">
Setup CDP smart wallet for subscription management (Node.js only)
</Card>

<Card title="prepareCharge" icon="receipt" href="/sdks/base-account/reference/base-pay/prepareCharge">
...
interface ChargeOptions {
  ...
  recipient?: Address;
  testnet?: boolean;
  /** Subscriber wallet; rejects if the permission payer does not match */
  expectedPayer?: Address;
  /** Optional; charge() already binds spender to the CDP smart wallet */
...
<CardGroup cols={3}>
<Card title="Accept Recurring Payments Guide" icon="book" href="/build-on-base/accept-payments/accept-subscriptions">
Learn how to implement recurring payments with Base Pay
</Card>

<Card title="One-Time Payments Guide" icon="book" href="/build-on-base/accept-payments/from-humans">
