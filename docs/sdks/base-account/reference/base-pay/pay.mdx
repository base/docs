...
<RequestExample>
```typescript Basic Payment lines wrap expandable
...
```typescript Payment with Data Collection lines wrap expandable
try {
  const payment = await pay({
    amount: "25.00",
    to: "0x1234567890123456789012345678901234567890",
...
```typescript Success Response with Data Collection lines wrap expandable
{
  id: "0xabcd1234...",
  amount: "25.00",
  to: "0x1234567890123456789012345678901234567890",
