...
Optional call-level capabilities. For example, [`gasLimitOverride`](/sdks/base-account/reference/core/capabilities/gasLimitOverride) allows you to specify a gas limit for an individual call.
</ParamField>
</Expandable>
</ParamField>
...
```json Request with call-level gas limit overrides lines wrap expandable
{
  "id": 1,
  "jsonrpc": "2.0",
  "method": "wallet_sendCalls",
