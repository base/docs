...
```json With Options lines wrap expandable
{
  "id": 1,
  "jsonrpc": "2.0",
  "method": "wallet_connect",
...
```json With signInWithEthereum Capability lines wrap expandable
{
  "id": 1,
  "jsonrpc": "2.0",
  "method": "wallet_connect",
...
<ResponseExample>
```json Basic Connection Response lines wrap expandable
{
  "id": 1,
  "jsonrpc": "2.0",
  "result": {
...
```json signInWithEthereum Response lines wrap expandable
{
  "id": 1,
  "jsonrpc": "2.0",
  "result": {
...
You can use the `wallet_connect` with the [`signInWithEthereum`](/sdks/base-account/reference/core/capabilities/signInWithEthereum) capability to authenticate the user.
