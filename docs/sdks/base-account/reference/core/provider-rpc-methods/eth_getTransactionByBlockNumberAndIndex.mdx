...
description: "Get a transaction by block number and transaction index position"
---
...
<RequestExample>
```json Latest Block lines wrap expandable
{
  "id": 1,
  "jsonrpc": "2.0",
...
```json Specific Block lines wrap expandable
{
  "id": 1,
  "jsonrpc": "2.0",
  "method": "eth_getTransactionByBlockNumberAndIndex",
