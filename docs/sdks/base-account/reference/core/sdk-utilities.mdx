...
### [generateKeyPair](/sdks/base-account/reference/core/generateKeyPair)
...
### [getKeypair](/sdks/base-account/reference/core/getKeypair)

Retrieves an existing P256 key pair if one has been previously generated and stored.

```tsx getKeypair lines wrap expandable
...
### [getCryptoKeyAccount](/sdks/base-account/reference/core/getCryptoKeyAccount)


```tsx getCryptoKeyAccount
...
```tsx Complete Integration Example lines wrap expandable
import { 
  generateKeyPair, 
  getKeypair, 
  getCryptoKeyAccount,
