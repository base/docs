...
<RequestExample>
```typescript Basic Authentication lines wrap expandable
...
```typescript Backend Verification lines wrap expandable
...
<ResponseExample>
```json Authentication Response lines wrap expandable
{
  "accounts": [{
...
```typescript Express.js Backend lines wrap expandable
...
```tsx React Integration lines wrap expandable
