...
The primary use case for `dataSuffix` is [Builder Codes](/specifications/builder-codes/overview) attribution. Builder Codes are unique identifiers that allow apps to receive attribution for onchain activity they generate.
...
<Info>
For wallet developers implementing `dataSuffix` support, see [Builder Codes for Wallet Developers](/specifications/builder-codes/for-wallet-developers).
</Info>
