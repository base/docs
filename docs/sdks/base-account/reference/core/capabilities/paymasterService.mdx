...
```typescript Send Sponsored Transaction lines wrap expandable
...
```typescript Gas Estimation Endpoint lines wrap expandable
...
```typescript Paymaster Data Endpoint lines wrap expandable
// pm_getPaymasterData
POST /rpc
{
  "jsonrpc": "2.0",
...
```typescript Complete Example lines wrap expandable
...
```typescript DeFi Onboarding lines wrap expandable
