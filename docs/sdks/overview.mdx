...
<CardGroup cols={2}>
  ...
  <Card title="Builder Codes" icon="code" href="/sdks/builder-codes/overview">
...
| Attribute transactions to an app, wallet, or agent | [Builder Codes](/sdks/builder-codes/overview) |
