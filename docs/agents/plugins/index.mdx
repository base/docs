...
<Tip>
This page describes how the Base MCP Skill and Plugins work under the hood. If you just want to install it in Claude Desktop, ChatGPT, Cursor, or Claude Code, head to the [Quickstart](/agents/quickstart).
</Tip>
...
```mermaid Calldata Plugin Flow lines wrap expandable
sequenceDiagram
    participant User
