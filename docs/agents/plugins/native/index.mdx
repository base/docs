...
Most transaction plugins follow the prepare → `send_calls` pattern described in the [Overview](/agents/plugins). Bankr uses Base MCP's `swap` tool for the purchase, and Virtuals uses Base MCP's `sign` tool only for SIWE login before continuing with a Virtuals session token. The plugin spec is the single source of truth; the cards below are pointers, not duplicates.
...
<CardGroup cols={2}>
  <Card
    title="Morpho"
    icon="puzzle-piece"
    href="/agents/plugins/native/morpho"
  >
  ...
  <Card
    title="Moonwell"
    icon="puzzle-piece"
    href="/agents/plugins/native/moonwell"
  >
  ...
  <Card
    title="Uniswap"
    icon="puzzle-piece"
    href="/agents/plugins/native/uniswap"
  >
  ...
  <Card
    title="Avantis"
    icon="puzzle-piece"
    href="/agents/plugins/native/avantis"
  >
  ...
  <Card
    ...
    icon="puzzle-piece"
    href="/agents/plugins/native/aerodrome"
  >
  ...
  <Card
    title="Virtuals"
    icon="puzzle-piece"
    href="/agents/plugins/native/virtuals"
  >
  ...
  <Card
    title="Bankr"
    icon="puzzle-piece"
    href="/agents/plugins/native/bankr"
  >
...
<CardGroup cols={1}>
  <Card
    ...
    icon="code"
    href="/agents/plugins/custom-plugins"
  >
