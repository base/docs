...
<Note>
  **Are you an agent?** If you're looking for the canonical machine-readable docs index, fetch [`AGENTS.md`](https://docs.base.org/AGENTS.md) — note the **uppercase** filename (`AGENTS.md`, not `agents.md`). It's a compact, directory-grouped index of the entire Base documentation, built for AI agents to navigate before generating code.
</Note>
