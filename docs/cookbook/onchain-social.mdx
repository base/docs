...
<Card title="Complete Integration Guide" icon="book" href="/wallet-app/build-with-minikit/existing-app-integration">
...
<Note>
For new projects, use the [MiniKit CLI](/wallet-app/build-with-minikit/quickstart) for automatic setup with all features pre-configured.
</Note>
...
<CardGroup cols={2}>
  <Card title="Notifications & Engagement" icon="bell" href="/wallet-app/build-with-minikit/overview#usenotification">
    Send push notifications to users who have added your Mini App
  </Card>
  <Card title="Authentication Patterns" icon="key" href="/wallet-app/build-with-minikit/overview#useauthenticate">
    Implement Farcaster authentication for secure, persistent sessions
  </Card>
  <Card title="Profile Integration" icon="user" href="/wallet-app/build-with-minikit/overview#useviewprofile">
    Navigate users to Farcaster profiles and build social connections
  </Card>
  <Card title="Frame Management" icon="plus" href="/wallet-app/build-with-minikit/overview#useaddframe">
...
<CardGroup cols={2}>
  <Card title="Social Design Patterns" icon="users" href="/wallet-app/guides/thinking-social">
  ...
  <Card title="Performance Optimization" icon="bolt" href="/wallet-app/build-with-minikit/overview#performance">
...
<CardGroup cols={2}>
  <Card title="MiniKit Documentation" icon="book" href="/wallet-app/build-with-minikit/overview">
    Complete documentation for building Mini Apps with MiniKit
  </Card>
  <Card title="MiniKit Quickstart" icon="rocket" href="/wallet-app/build-with-minikit/quickstart">
