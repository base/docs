...
<Card title="Complete Integration Guide" icon="book" href="/builderkits/minikit/existing-app-integration">
...
<CardGroup cols={2}>
  <Card title="Notifications & Engagement" icon="bell" href="/builderkits/minikit/overview#usenotification">
    Send push notifications to users who have added your Mini App
  </Card>
  <Card title="Authentication Patterns" icon="key" href="/builderkits/minikit/overview#useauthenticate">
    Implement Farcaster authentication for secure, persistent sessions
  </Card>
  <Card title="Profile Integration" icon="user" href="/builderkits/minikit/overview#useviewprofile">
    Navigate users to Farcaster profiles and build social connections
  </Card>
  <Card title="Frame Management" icon="plus" href="/builderkits/minikit/overview#useaddframe">
...
<CardGroup cols={2}>
  <Card title="Social Design Patterns" icon="users" href="/builderkits/minikit/thinking-social">
    Design patterns and best practices for building social Mini Apps
  </Card>
  <Card title="Debugging Guide" icon="bug" href="/builderkits/minikit/debugging">
    Common issues and solutions when developing Mini Apps
  </Card>
  <Card title="Performance Optimization" icon="bolt" href="/builderkits/minikit/overview#performance">
...
<CardGroup cols={2}>
  <Card title="MiniKit Documentation" icon="book" href="/builderkits/minikit/overview">
    Complete documentation for building Mini Apps with MiniKit
  </Card>
  <Card title="MiniKit Quickstart" icon="rocket" href="/builderkits/minikit/quickstart">
