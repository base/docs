...
This guide shows how to sign an EIP-1559 transaction with Viem and submit it with validity predicates. The API also supports signed legacy and EIP-2930 transactions.
