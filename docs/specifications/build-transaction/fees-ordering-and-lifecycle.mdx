...
Add a `block_number` predicate with a maximum block to limit a transaction's lifetime. Use `flashblock_index` to constrain a transaction to a position within a Flashblock.
