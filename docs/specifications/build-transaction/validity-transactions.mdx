...
Validity Transactions let you submit a signed transaction with conditions on Base state. The API supports legacy, EIP-2930, and EIP-1559 transactions. Use them for conditional swaps, withdrawals, and other state-dependent actions.
