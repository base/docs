...
<Steps>
  <Step title="Support the dataSuffix Capability">
    ...
    ```typescript DataSuffix capability type
  ...
  <Step title="Append Suffix to Calldata">
    ...
    <Tabs>
      <Tab title="EOA Transactions">
        ...
        ```typescript apply-eoa-suffix.ts lines expandable wrap
      ...
      <Tab title="ERC-4337 User Operations">
        ...
        ```typescript apply-user-operation-suffix.ts lines expandable wrap
  ...
  <Step title="Add Wallet Attribution (Optional)">
    ...
    **Example:**
    ...
    ```typescript Compose app and wallet attribution
