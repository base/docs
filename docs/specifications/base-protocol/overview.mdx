...
```mermaid Protocol Architecture lines wrap expandable
graph LR
    subgraph "Ethereum L1"
        OptimismPortal(<a href="/specifications/base-protocol/bridging/withdrawals#the-optimism-portal-contract">OptimismPortal</a>)
        BatchInbox(<a href="/specifications/reference/glossary#batcher-transaction">Batch Inbox Address</a>)
        DisputeGameFactory(<a href="/specifications/base-protocol/proofs/proof-contracts#disputegamefactory">DisputeGameFactory</a>)
    end

    subgraph "L2 Node"
        RollupNode(<a href="/specifications/base-protocol/consensus/specification">Consensus</a>)
        ExecutionEngine(<a href="/specifications/base-protocol/execution/l2-execution-engine">Execution Engine</a>)
    end

    Batcher(<a href="/specifications/base-protocol/batcher">Batcher</a>)
    Proposers(Proposers)
...
[Consensus →](/specifications/base-protocol/consensus/specification)

```mermaid Consensus Components lines wrap expandable
graph LR
    L1(Ethereum L1)
...
[Execution →](/specifications/base-protocol/execution/l2-execution-engine)
...
[Bridging →](/specifications/base-protocol/bridging/deposits)

```mermaid Deposit Flow lines wrap expandable
graph LR
...
[Batcher →](/specifications/base-protocol/batcher)
...
graph LR
    ...
    Batcher(<a href="/specifications/base-protocol/batcher">Batcher</a>)
    BatchInbox(<a href="/specifications/reference/glossary#batcher-transaction">Batch Inbox Address</a>)
    RollupNode(<a href="/specifications/base-protocol/consensus/specification">Rollup Node</a>)
...
[Proofs →](/specifications/base-protocol/proofs/overview)

```mermaid Proof Flow lines wrap expandable
graph LR
    Proposer(Proposer)
    DGF(<a href="/specifications/base-protocol/proofs/proof-contracts#disputegamefactory">DisputeGameFactory</a>)
    Game(<a href="/specifications/base-protocol/proofs/proof-contracts#aggregateverifier">AggregateVerifier game</a>)
    Challengers(Challengers)
    OP(<a href="/specifications/base-protocol/bridging/withdrawals#the-optimism-portal-contract">OptimismPortal</a>)
...
```mermaid Transaction Flow lines wrap expandable
graph TD
    subgraph "Ethereum L1"
        OptimismPortal(<a href="/specifications/base-protocol/bridging/withdrawals#the-optimism-portal-contract">OptimismPortal</a>)
        BatchInbox(<a href="/specifications/reference/glossary#batcher-transaction">Batch Inbox Address</a>)
...
```mermaid Withdrawal Flow lines wrap expandable
graph LR
    subgraph "Ethereum L1"
        BatchInbox(<a href="/specifications/reference/glossary#batcher-transaction">Batch Inbox Address</a>)
        DisputeGameFactory(<a href="/specifications/base-protocol/proofs/proof-contracts#disputegamefactory">DisputeGameFactory</a>)
        ProofGame(<a href="/specifications/base-protocol/proofs/proof-contracts#aggregateverifier">AggregateVerifier game</a>)
        OptimismPortal(<a href="/specifications/base-protocol/bridging/withdrawals#the-optimism-portal-contract">OptimismPortal</a>)
