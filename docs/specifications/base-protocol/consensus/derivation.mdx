...
[g-derivation]: /specifications/reference/glossary#l2-chain-derivation
[g-payload-attr]: /specifications/reference/glossary#payload-attributes
[g-block]: /specifications/reference/glossary#block
[g-exec-engine]: /specifications/reference/glossary#execution-engine
[g-reorg]: /specifications/reference/glossary#chain-re-organization
[g-receipts]: /specifications/reference/glossary#receipt
[g-deposit-contract]: /specifications/reference/glossary#deposit-contract
[g-deposited]: /specifications/reference/glossary#deposited-transaction
[g-l1-attr-deposit]: /specifications/reference/glossary#l1-attributes-deposited-transaction
[g-l1-origin]: /specifications/reference/glossary#l1-origin
[g-user-deposited]: /specifications/reference/glossary#user-deposited-transaction
[g-deposits]: /specifications/reference/glossary#deposits
[g-sequencing]: /specifications/reference/glossary#sequencing
[g-sequencer]: /specifications/reference/glossary#sequencer
[g-sequencing-epoch]: /specifications/reference/glossary#sequencing-epoch
[g-sequencing-window]: /specifications/reference/glossary#sequencing-window
[g-sequencer-batch]: /specifications/reference/glossary#sequencer-batch
[g-l2-genesis]: /specifications/reference/glossary#l2-genesis-block
[g-l2-chain-inception]: /specifications/reference/glossary#l2-chain-inception
[g-l2-genesis-block]: /specifications/reference/glossary#l2-genesis-block
[g-batcher-transaction]: /specifications/reference/glossary#batcher-transaction
[g-avail-provider]: /specifications/reference/glossary#data-availability-provider
[g-batcher]: /specifications/reference/glossary#batcher
[g-l2-output]: /specifications/reference/glossary#l2-output-root
[g-fault-proof]: /specifications/reference/glossary#fault-proof
[g-channel]: /specifications/reference/glossary#channel
[g-channel-frame]: /specifications/reference/glossary#channel-frame
[g-rollup-node]: /specifications/reference/glossary#rollup-node
[g-block-time]: /specifications/reference/glossary#block-time
[g-time-slot]: /specifications/reference/glossary#time-slot
[g-consolidation]: /specifications/reference/glossary#unsafe-block-consolidation
[g-safe-l2-head]: /specifications/reference/glossary#safe-l2-head
[g-safe-l2-block]: /specifications/reference/glossary#safe-l2-block
[g-unsafe-l2-head]: /specifications/reference/glossary#unsafe-l2-head
[g-unsafe-l2-block]: /specifications/reference/glossary#unsafe-l2-block
[g-unsafe-sync]: /specifications/reference/glossary#unsafe-sync
[g-deposit-tx-type]: /specifications/reference/glossary#deposited-transaction-type
[g-finalized-l2-head]: /specifications/reference/glossary#finalized-l2-head
[g-system-config]: /specifications/reference/glossary#system-configuration
...
| --------- | ----------------------- | ---------------------- | ------- | ----- |
| `max_sequencer_drift` | 600 | 1800 | [Fjord](/base-chain/specs/upgrades/fjord/derivation#constant-maximum-sequencer-drift) | Changed from a chain parameter to a constant with Fjord. |
| `MAX_RLP_BYTES_PER_CHANNEL` | 10,000,000 | 100,000,000 | [Fjord](/base-chain/specs/upgrades/fjord/derivation#increasing-max_rlp_bytes_per_channel-and-max_channel_bank_size) | Constant increased with Fjord. |
| `MAX_CHANNEL_BANK_SIZE` | 100,000,000 | 1,000,000,000 | [Fjord](/base-chain/specs/upgrades/fjord/derivation#increasing-max_rlp_bytes_per_channel-and-max_channel_bank_size) | Constant increased with Fjord. |
| `MAX_SPAN_BATCH_ELEMENT_COUNT` | 10,000,000 | 10,000,000 | Effectively introduced in [Fjord](/base-chain/specs/upgrades/fjord/derivation#increasing-max_rlp_bytes_per_channel-and-max_channel_bank_size)| Number of elements |
...
[batcher-spec]: /specifications/base-protocol/batcher
...
format](/base-chain/specs/upgrades/fjord/derivation#brotli-channel-compression) to support alternate compression
algorithms.
...
[span-batches]: /base-chain/specs/upgrades/delta/span-batches
...
- `batch.transactions`: `drop` if the `batch.transactions` list contains a transaction
  ...
  - any transaction of a future type > 2 (note that
    [Isthmus adds support](/base-chain/specs/upgrades/isthmus/derivation#activation)
...
[exec-engine]: /specifications/base-protocol/execution/l2-execution-engine
...
[`engine_forkchoiceUpdatedV2`]: /specifications/base-protocol/execution/l2-execution-engine#engine_forkchoiceupdatedv2
[`engine_forkchoiceUpdatedV3`]: /specifications/base-protocol/execution/l2-execution-engine#engine_forkchoiceupdatedv3
[`engine_getPayloadV2`]: /specifications/base-protocol/execution/l2-execution-engine#engine_getpayloadv2
[`engine_getPayloadV3`]: /specifications/base-protocol/execution/l2-execution-engine#engine_getpayloadv3
[`engine_getPayloadV4`]: /specifications/base-protocol/execution/l2-execution-engine#engine_getpayloadv4
[`engine_newPayloadV2`]: /specifications/base-protocol/execution/l2-execution-engine#engine_newpayloadv2
[`engine_newPayloadV3`]: /specifications/base-protocol/execution/l2-execution-engine#engine_newpayloadv3
[`engine_newPayloadV4`]: /specifications/base-protocol/execution/l2-execution-engine#engine_newpayloadv4
...
[exec-engine-comm]: /specifications/base-protocol/execution/l2-execution-engine#engine-api
...
[expanded-payload]: /specifications/base-protocol/execution/l2-execution-engine#extended-payloadattributesv1
...
[deposit-contract-spec]: /specifications/base-protocol/bridging/deposits#deposit-contract
...
[extended-attributes]: /specifications/base-protocol/execution/l2-execution-engine#extended-payloadattributesv1
[Fee Vaults]: /specifications/base-protocol/execution/l2-execution-engine#fee-vaults
