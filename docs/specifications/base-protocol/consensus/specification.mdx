...
[g-reorg]: /specifications/reference/glossary#re-organization
[g-rollup-driver]: /specifications/reference/glossary#rollup-driver
...
For a complete specification of the L2 block derivation, refer to the [L2 block derivation document](/specifications/base-protocol/consensus/derivation).

The rollup node RPC surface is specified in the [RPC](/specifications/base-protocol/consensus/rpc) document.
...
[`engine_signalSuperchainV1`](/specifications/base-protocol/execution/l2-execution-engine) call.
