---
title: "Proposer"
description: "Specification of the proposer, an offchain service that turns canonical L2 checkpoint ranges into AggregateVerifier games on L1."
---
...
```text Game Implementation Lookup
...
```text Aggregate Proposal Fields
outputRoot
signature
l1OriginHash
l1OriginNumber
...
```text Aggregate Proposal Values
