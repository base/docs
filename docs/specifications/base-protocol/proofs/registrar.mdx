---
title: "Registrar"
description: "Specification of the registrar, an offchain service that maintains the onchain registry of accepted TEE signer identities via attestation ZK proofs."
---
...
```mermaid Pending Registration Lifecycle lines wrap expandable
flowchart TB
