...
specific PCR0, which the [registrar](/specifications/base-protocol/proofs/registrar) certifies separately.
...
[registrar](/specifications/base-protocol/proofs/registrar) spec for how attestations are verified and submitted onchain.
