...
[Precompiled contracts](/specifications/reference/glossary#precompiled-contract-precompile) exist on Base at
...
With the [Azul hardfork](/upgrades/azul/exec-engine#secp256r1-precompile-gas-cost), the gas cost was updated to **6,900** to match [EIP-7951](https://eips.ethereum.org/EIPS/eip-7951) and maintain strict equivalence with L1 precompile pricing.

Address: `0x0000000000000000000000000000000000000100`

## Standard Ethereum Precompile Modifications (Azul)

The [Azul hardfork](/upgrades/azul/exec-engine) introduced changes to two standard Ethereum precompiles:
