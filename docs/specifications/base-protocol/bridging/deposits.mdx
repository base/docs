...
[g-transaction-type]: /specifications/reference/glossary#transaction-type
[g-derivation]: /specifications/reference/glossary#L2-chain-derivation
[g-deposited]: /specifications/reference/glossary#deposited
...
[g-eoa]: /specifications/reference/glossary#eoa
...
The [Interop derivation spec](/specifications/base-protocol/consensus/derivation) introduces two additional kinds of system deposits,
...
- System configurables tied to the L1 block, see [System configuration specification](/specifications/base-protocol/consensus/derivation#system-configuration):
...
```python Guaranteed Gas Market Pseudocode lines wrap expandable
