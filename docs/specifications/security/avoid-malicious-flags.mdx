...
- **Verify Smart Contract**: Ensure that the source code of your contracts is verified and publicly available through a block explorer listed in the [Builder Stack](/get-started/builder-stack). For example, you can verify a contract on [Etherscan](https://etherscan.io/verifyContract) or [Basescan](https://basescan.org/verifyContract) under “Verify Contract”.
