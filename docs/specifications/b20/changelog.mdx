...
- [B20Factory](/specifications/b20/reference/interfaces/ib20-factory/create-b20) singleton precompile with deterministic, variant-encoding addresses and `initCalls` bootstrap semantics
