...
<CardGroup cols={2}>
  <Card title="Overview" icon="book-open" href="/specifications/b20/specification-overview">
    Start with B20's purpose, core primitives, and token-creation flow.
  </Card>
  <Card title="Execution Architecture" icon="diagram-project" href="/specifications/b20/architecture">
