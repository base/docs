---
title: "Events"
description: "Events emitted by B20 token, factory, policy registry, and activation registry interfaces."
---
...
## [`IERC8056`](https://github.com/base/base-std/blob/main/src/interfaces/IERC8056.sol) (`IScaledUIAmount`)
