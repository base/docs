---
title: "Errors"
description: "Custom B20 errors, selectors, and the conditions that trigger them."
---
...
*Note: several error names are reused across files with different parameters (or none), which changes the selector. `PolicyNotFound()` ([`IPolicyRegistry`](/specifications/b20/reference/interfaces/i-policy-registry)) and `PolicyNotFound(uint64)` ([`IB20`](/specifications/b20/reference/interfaces/ib20)) are unrelated errors with different selectors, as are `Unauthorized()` (`IB20` / `IPolicyRegistry`) and `Unauthorized(address)` ([`IActivationRegistry`](/specifications/b20/reference/interfaces/i-activation-registry)). Conversely, `LengthMismatch(uint256,uint256)` shares one selector across [`IB20Asset`](/specifications/b20/reference/interfaces/ib20-asset) and [`B20FactoryLib`](https://github.com/base/base-std/blob/main/src/lib/B20FactoryLib.sol) — they're independently declared but identical in signature.*

## [`IB20`](/specifications/b20/reference/interfaces/ib20)
...
| `AccountNotSeizable(address account)` | `0x91dbbc8d` | `seizeWithMemo` was called against a `from` that is seize-exempt (still authorized) under `SEIZE_EXEMPT_POLICY`. |
...
## [`IB20Asset`](/specifications/b20/reference/interfaces/ib20-asset)
...
## [`IB20Factory`](/specifications/b20/reference/interfaces/ib20-factory)
...
## [`IPolicyRegistry`](/specifications/b20/reference/interfaces/i-policy-registry)
...
## [`IActivationRegistry`](/specifications/b20/reference/interfaces/i-activation-registry)
...
## [`B20FactoryLib`](https://github.com/base/base-std/blob/main/src/lib/B20FactoryLib.sol)
