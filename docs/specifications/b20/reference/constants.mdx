...
| Name | Value | Purpose |
|---|---|---|
| `B20_FACTORY_ADDRESS` | `0xB20f000000000000000000000000000000000000` | Deploys and looks up B-20 tokens; every asset and stablecoin instance is created through the [`IB20Factory`](/specifications/b20/reference/interfaces/ib20-factory) at this address. |
...
*Fixed-point constants used by the multiplier/rebasing surface. See [`IB20Asset`](/specifications/b20/reference/interfaces/ib20-asset).*
