...
sidebarTitle: "IB20 Asset"
description: "Reference for IB20Asset functions, events, and errors."
---
...
| [`batchMint`](/specifications/b20/reference/interfaces/ib20-asset/batch-mint) | `0x68573107` | Mints `amounts[i]` to `recipients[i]` in one call. All-or-nothing: any element failing — including any recipient being `address(0)` or `address(this)` — reverts the entire batch. |
