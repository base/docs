...
description: "Returns the OPERATOR_ROLE constant that gates multiplier scheduling and corporate action announcement on B20 Asset."
---
...
- `announce` — disclose a corporate action
