...
<Warning>
We're planning on deprecating Flashblocks in the upcoming Cobalt hardfork. This is a planned upgrade that has not yet been finalized. You can now test canonical 200ms block behavior early on [Vibenet](/build-on-base/test-on-vibenet). See [Migrate From Flashblocks](/upgrades/cobalt/migrate-from-flashblocks) for the eventual required application changes.
</Warning>
