...
<Warning>
Flashblocks will be deprecated in the upcoming Denim hardfork. You can now test canonical 200ms block behavior on [Vibenet](/build-on-base/test-on-vibenet). See [Migrate From Flashblocks](/base-chain/specs/upgrades/denim/migrate-from-flashblocks) for the required application changes.
</Warning>
