...
```bash
git clone https://github.com/base/skills.git base-skills
```
</Step>
<Step title="Copy the migration skill into your project">
For Claude Code:
```bash
cp -r base-skills/skills/migrating-an-onchainkit-app .claude/skills/
```
For Cursor:
```bash
