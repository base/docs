...
### Base Batches 002 (2025)

Base has expanded its builder support through Base Batches 002, which launched in September 2025 and includes:

- **Funding, mentorship, and distribution from day one** for new developers
- **Over $500K in prizes** for admitted teams
- **Virtual Mentorship Portal Access**: book 1:1 sessions with industry veterans and experts across specialties
- **Resource Credits**: ad credits, development resources, and audit support
- **Demo Day at Devconnect** in Argentina to showcase projects to VCs, angels, and accelerators

The program brought together 5,000+ developers from 100+ countries in Base Batches 001, with 77 teams making finals and over $1 million in funding awarded.

### Base Build Dashboard

Base has launched enhanced tools for builders to grow and earn, including real-time user analytics and builder rewards programs that distribute funding to active developers.

### Network Token Exploration

Base announced it is exploring a network token to accelerate decentralization and expand opportunities for builders and creators across the ecosystem, marking a significant strategic shift announced at BaseCamp 2025.
