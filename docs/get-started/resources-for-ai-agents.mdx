...
| --- | --- |
| Building an AI agent on Base | [Use Base with AI](/get-started/use-base-with-ai) |
| Setting up Base MCP wallet access and signing | [Get Started with Base MCP](/get-started/use-base-with-ai) |
| Adding payments or onchain transactions | [Make x402 payments](/build-on-base/agentic-payments/pay-for-apis-with-x402) |
| Registering an agent for onchain attribution | [Builder Codes for Agents](/sdks/overview) |
| Using AI tools with Base Account | [Base Account quickstart for AI tools](/sdks/base-account/quickstart/ai-tools-available-for-devs) |
