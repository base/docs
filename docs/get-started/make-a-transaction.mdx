...
```ts send.ts lines wrap expandable
...
<Tip>
Transactions confirm in under a second on Base thanks to [Flashblocks](/specifications/transactions/transaction-ordering#flashblocks), and typically cost a fraction of a cent in gas.
</Tip>
