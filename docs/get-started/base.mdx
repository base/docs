...
<div className="use-cases">
  ...
  <div className="use-cases-links">
    ### Agents
    [Get Started with Base MCP](/ai-agents)
    [Make x402 Payments](/ai-agents/guides/x402-payments)
    [Swap Tokens](/ai-agents/guides/swap-tokens)
  </div>
  <div className="use-cases-links">
    ### Tokens
    [Launch a Token](/get-started/launch-token)
    [Bridge from Solana](/base-chain/network-information/base-solana-bridge)
    [Bridge from Ethereum](/base-chain/network-information/bridging-and-withdrawals)
  </div>
</div>
...
<CardGroup cols={4}>
  ...
  <Card title="Solana Bridge" icon="bridge" href="/base-chain/network-information/base-solana-bridge">
