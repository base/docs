...
<Frame>
  <img alt="Screenshot of the OnchainKit app template displaying the default landing page and wallet connection option" src="/images/onchainkit/quickstart.png" height="364" />
</Frame>
