...
Before starting, ensure you have Node.js v20+ installed. You can verify by running:
```bash
node --version
```
...
<Frame>
  ...
  **Installation Time**
  ...
  Foundry installation may take a few minutes to complete. Once finished, you should see a success message.
  </Note>
