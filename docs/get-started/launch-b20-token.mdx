...
* Your token currently allows every transfer, by everyone, to anyone. That is a choice, not an accident — [learn how B20 policies work](/base-chain/specs/upgrades/beryl/b20/specification/concepts/policies-and-scopes) to change it.
