...
A standard ERC-20 leaves that logic for you to build, audit, and maintain. With B20, you call the singleton [**B20 Factory**](/specs/cobalt/b20/overview#8-factory-and-deployment) to create a token, fully configured, in a single transaction.
...
* Gate transfers or mints with PolicyRegistry policies, add granular pause, or manage roles. See the [B20 token standard](/specs/cobalt/b20/overview).