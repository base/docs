...
[`Promise<GetPortfoliosResponse>`](/builderkits/onchainkit/api/types#getportfoliosresponse)

## Parameters

[`GetPortfoliosParams`](/builderkits/onchainkit/api/types#getportfoliosparams)
