...
Additionally, you can see the [`<Identity>`](/builderkits/onchainkit/identity/identity) components
like [`<Avatar>`](/builderkits/onchainkit/identity/avatar), [`<Name>`](/builderkits/onchainkit/identity/name),
and [`<Address>`](/builderkits/onchainkit/identity/address) are used in a composable way.
...
Expand the user experience with pre-made components like [`<WalletDropdownLink>`](/builderkits/onchainkit/wallet/wallet-dropdown-link),
[`<WalletDropdownBasename>`](/builderkits/onchainkit/wallet/wallet-dropdown-basename),
[`<WalletDropdownFundLink>`](/builderkits/onchainkit/wallet/wallet-dropdown-fund-link),
