...
- **Missing OnchainKitProvider**
  ...
  - Solution: Wrap your app with OnchainKitProvider and [configure](/builderkits/onchainkit/getting-started) properly:
...
- **Connection Failed**
  ...
  - Solutions:
    ...
    - Check [supported chains configuration](/builderkits/onchainkit/wallet/wallet)
...
- **Gas Estimation Failed**
  ...
  - Solutions:
    ...
    - Ensure proper network [configuration](/builderkits/onchainkit/transaction/transaction)
