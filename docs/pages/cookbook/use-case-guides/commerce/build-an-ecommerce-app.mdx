...
![pay-commerce-uuid](/images/onchainkit-tutorials/pay-commerce-products.png)
...
![pay-commerce-uuid](/images/onchainkit-tutorials/pay-create-product-details.png)
...
![pay-commerce-uuid](/images/onchainkit-tutorials/pay-copy-product-link.png)
...
```typescript filename="src/app/components/OnchainProviders.tsx"
'use client';
...
![pay-commerce-uuid](/images/onchainkit-tutorials/pay-final-product.png)
