...
export const AgentRegistrationDemo = () => {
  ...
  const steps = [
    { delay: 400, lines: [{ t: "> Show my last 5 transactions on Base", c: "active" }] },
    { delay: 500, lines: [
      { t: "  ── get_transaction_history ────────────────", c: "dim" },
      { t: "  chain: base  limit: 5", c: "muted" },
    ]},
    { delay: 700, lines: [
      { t: "  send   -10.00 USDC   alice.base.eth  2min ago", c: "code" },
      { t: "  swap  -100.00 USDC   +0.0351 ETH     1hr ago ", c: "code" },
      { t: "  recv   +50.00 USDC   coinbase.com    3hr ago ", c: "success" },
      { t: "  send    -5.00 USDC   bob.eth         1d ago  ", c: "code" },
      { t: "  recv  +100.00 USDC   0x9f3a...2e01   2d ago  ", c: "success" },
    ]},
    { delay: 500, lines: [{ t: "", c: "dim" }, { t: "> What's my current balance?", c: "active" }] },
    { delay: 500, lines: [
      { t: "  ── get_portfolio ──────────────────────────", c: "dim" },
    ]},
    { delay: 650, lines: [
      { t: "  USDC    280.80   $280.80", c: "success" },
      { t: "  ETH     0.0763   $274.33", c: "success" },
      { t: "  DEGEN  4820.00   $182.33", c: "success" },
      { t: "  Total:  $737.46 on Base", c: "success" },
    ]},
  ];
  ...
  return (
    <div style={{ margin: "28px 0", borderRadius: 12, overflow: "hidden", border: "1px solid #27272a", background: "#09090b" }}>
      <div style={{ display: "flex", alignItems: "center", padding: "8px 12px", background: "#111113", borderBottom: "1px solid #27272a" }}>
        ...
        <span style={{ fontFamily: mono, fontSize: 12, color: "#52525b" }}>Transaction History</span>
        <div style={{ flex: 1 }} />
      ...
      <div style={{ height: 270, borderBottom: "1px solid #27272a", display: "flex", flexDirection: "column" }}>
