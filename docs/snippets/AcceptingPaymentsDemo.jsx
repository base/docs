...
export const AcceptingPaymentsDemo = () => {
  ...
  const steps = [
    { delay: 350, left: [{ t: "> npm install x402-express express", c: "active" }], right: [
      { t: "── Middleware Config ───────────────────", c: "dim" },
      { t: "{", c: "code" },
    ]},
    { delay: 650, left: [{ t: "  ✓ x402-express installed", c: "success" }], right: [
      { t: '  "path": "/api/data",', c: "code" },
      { t: '  "price": "$0.01",', c: "code" },
      { t: '  "network": "base",', c: "code" },
      { t: '  "payTo": "0x742d...c4f2"', c: "code" },
      { t: "}", c: "code" },
    ]},
    { delay: 500, left: [{ t: "> configure x402 middleware...", c: "active" }], right: [] },
    { delay: 600, left: [{ t: "  ✓ paymentMiddleware applied", c: "success" }], right: [] },
    { delay: 400, left: [{ t: "  ✓ endpoint live: /api/data · $0.01/req", c: "success" }], right: [
      { t: "", c: "dim" },
      { t: "── Live endpoint ───────────────────────", c: "dim" },
      { t: "  GET /api/data → 402 (unpaid)", c: "muted" },
      { t: "  GET /api/data + sig → 200 (paid)", c: "success" },
    ]},
    { delay: 900, left: [{ t: "  waiting for requests...", c: "muted" }], right: [
      { t: "", c: "dim" },
      { t: "── Incoming request ────────────────────", c: "dim" },
      { t: "GET /api/data", c: "code" },
      { t: "X-Payment-Sig: 0xc3d1...f891", c: "success" },
    ]},
    { delay: 700, left: [{ t: "  ← payment verified · 0.01 USDC", c: "muted" }], right: [
      { t: "", c: "dim" },
      { t: "── Payment verified ────────────────────", c: "dim" },
      { t: "  amount: 0.01 USDC ✓", c: "success" },
      { t: "  sig valid: true ✓", c: "success" },
    ]},
    { delay: 400, left: [{ t: "  ✓ serving data  · balance +0.01 USDC", c: "success", bold: true }], right: [] },
  ];
  ...
  return (
    <div style={{ margin: "28px 0", borderRadius: 12, overflow: "hidden", border: "1px solid #27272a", background: "#09090b" }}>
      <div style={{ display: "flex", alignItems: "center", padding: "8px 12px", background: "#111113", borderBottom: "1px solid #27272a" }}>
        ...
        <span style={{ fontFamily: mono, fontSize: 12, color: "#52525b" }}>Accepting Payments</span>
        <div style={{ flex: 1 }} />
