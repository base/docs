...
export const Danger = ({ children }) => {
  return (
    <div className="my-4 px-5 py-4 overflow-hidden rounded-2xl flex gap-3 border danger-admonition dark:danger-admonition">
      ...
      <div className="text-sm prose min-w-0">
        {children}
      </div>
    </div>
  );
