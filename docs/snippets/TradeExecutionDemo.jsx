export const TradeExecutionDemo = () => {
  ...
  // confirms the swap-review modal, then resumes and settles the trade.
  const examples = [
    {
      prompt: "Swap 100 USDC for ETH on Base",
      events: [
        { delay: 380, type: "thinking" },
        { delay: 460, type: "text", text: "I'll quote the best route for 100 USDC → ETH through the Base MCP." },
        { delay: 650, type: "tool", tool: { server: "base-mcp", name: "get_swap_quote", desc: "Routes the trade and returns the expected output amount.", args: { fromToken: "USDC", toToken: "ETH", amount: "100", chain: "base" } } },
        { delay: 520, type: "text", text: "Best route returns 0.0271 ETH for 100 USDC. Approve the swap to execute it:" },
        ...
        { delay: 520, type: "tool", tool: { server: "base-mcp", name: "swap", desc: "Submits the signed swap and waits for the receipt.", args: { fromToken: "USDC", toToken: "ETH", amount: "100", chain: "base" } } },
        { delay: 460, type: "text", text: "Swap confirmed on Base. Trade summary:" },
        { delay: 220, type: "rows", cols: ["field", "value", "detail"], rows: [
          ["Sold", "100 USDC", "from wallet"],
          ["Received", "0.0271 ETH", "≈ $99.94"],
          ["Rate", "1 ETH = 3,690 USDC", "best route"],
          ["Tx", "0x9f3a…c21b", "confirmed on Base"],
        ] },
        { delay: 380, type: "confirm", text: "Swapped 100 USDC for 0.0271 ETH." },
      ],
    },
    {
      prompt: "Swap 0.05 ETH into USDC",
      events: [
        { delay: 380, type: "thinking" },
        { delay: 460, type: "text", text: "I'll price 0.05 ETH → USDC and find the best route on Base." },
        { delay: 650, type: "tool", tool: { server: "base-mcp", name: "get_swap_quote", desc: "Routes the trade and returns the expected output amount.", args: { fromToken: "ETH", toToken: "USDC", amount: "0.05", chain: "base" } } },
        { delay: 520, type: "text", text: "You'll receive about 184.20 USDC for 0.05 ETH. Approve the swap to execute it:" },
        { delay: 220, type: "approval", preview: {
          title: "Approve swap", subtitle: "You are swapping tokens on Base.",
        ...
        { delay: 520, type: "tool", tool: { server: "base-mcp", name: "swap", desc: "Submits the signed swap and waits for the receipt.", args: { fromToken: "ETH", toToken: "USDC", amount: "0.05", chain: "base" } } },
        { delay: 460, type: "text", text: "Swap confirmed on Base. Trade summary:" },
        { delay: 220, type: "rows", cols: ["field", "value", "detail"], rows: [
          ["Sold", "0.05 ETH", "from wallet"],
          ["Received", "184.20 USDC", "≈ $184.20"],
          ["Rate", "1 ETH = 3,690 USDC", "best route"],
          ["Tx", "0x4b8e…7dd0", "confirmed on Base"],
        ] },
        { delay: 380, type: "confirm", text: "Swapped 0.05 ETH for 184.20 USDC." },
      ],
    },
    {
      prompt: "Swap 250 USDC for cbBTC",
      events: [
        { delay: 380, type: "thinking" },
        { delay: 460, type: "text", text: "I'll look up cbBTC, then quote 250 USDC → cbBTC on Base." },
        { delay: 550, type: "tool", tool: { server: "base-mcp", name: "search_tokens", desc: "Resolves the token symbol to its Base contract.", args: { query: "cbBTC", chain: "base" } } },
        { delay: 400, type: "tool", tool: { server: "base-mcp", name: "get_swap_quote", desc: "Routes the trade and returns the expected output amount.", args: { fromToken: "USDC", toToken: "0xcbB7…B4Cf", amount: "250", chain: "base" } } },
        { delay: 520, type: "text", text: "Best route returns 0.00260 cbBTC for 250 USDC. Approve the swap to execute it:" },
        { delay: 220, type: "approval", preview: {
          title: "Approve swap", subtitle: "You are swapping tokens on Base.",
        ...
        { delay: 520, type: "tool", tool: { server: "base-mcp", name: "swap", desc: "Submits the signed swap and waits for the receipt.", args: { fromToken: "USDC", toToken: "0xcbB7…B4Cf", amount: "250", chain: "base" } } },
        { delay: 460, type: "text", text: "Swap confirmed on Base. Trade summary:" },
        { delay: 220, type: "rows", cols: ["field", "value", "detail"], rows: [
          ["Sold", "250 USDC", "from wallet"],
          ["Received", "0.00260 cbBTC", "≈ $249.60"],
          ["Rate", "1 cbBTC = 96,000 USDC", "best route"],
          ["Tx", "0xa1c5…33ef", "confirmed on Base"],
        ] },
        { delay: 380, type: "confirm", text: "Swapped 250 USDC for 0.00260 cbBTC." },
      ],
    },
  ];
  ...
  return (
    <div className="as" style={{ position: "relative", margin: "22px 0", maxWidth: 760, borderRadius: 8, border: `1px solid ${C.border}`, background: C.white, overflow: "hidden", boxShadow: "0 1px 2px rgba(10,11,13,.04)" }}>
      ...
      <div ref={scrollRef} className="as-body">
        {!ex ? (
          <div className="as-land">
            <div>
              <div style={{ fontFamily: sans, fontSize: 20, fontWeight: 600, letterSpacing: "-0.02em", color: C.ink, lineHeight: 1.25 }}>Execute trades on Base</div>
      ...
      <div style={{ padding: "12px 16px 14px", borderTop: `1px solid ${C.border}`, background: C.white }}>
        ...
        <div style={{ textAlign: "center", marginTop: 8, fontFamily: sans, fontSize: 11, color: C.sub }}>Demo · every swap requires your approval — AI responses can make mistakes.</div>
      </div>
    </div>
  );
};
