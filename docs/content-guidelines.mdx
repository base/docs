...
description: "Writing rules, specification page structure, and changelog entry format for Base documentation."
---
...
- Code blocks longer than 7 lines should:
  - Have line numbers by adding `lines` to the first line of the codeblock
...
| Component | Use for |
|-----------|---------|
| **Steps** | Procedures and sequential instructions |
| **Tabs** | Platform-specific content or alternative approaches |
| **CodeGroup** | Same concept in multiple programming languages or frameworks |
| **Accordions** | Progressive disclosure of information |
| **RequestExample / ResponseExample** | API endpoint documentation |
