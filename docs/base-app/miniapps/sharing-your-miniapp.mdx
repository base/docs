...
<Note>
If you're using MiniKit, this metadata setup is done for you see [Using MiniKit for embeds](#using-minikit-for-embeds).
</Note>
...
<Info>
Check out or debugging section that covers embed issues (here)[/base-app/mininapps/debugging]
</Info>
