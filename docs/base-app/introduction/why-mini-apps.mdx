...
<Step title="Build your Mini App">
  ...
  <Info>
  No special permissions or approval processes required—build freely.
  </Info>
</Step>
...
<Warning>
The question isn't whether Mini Apps will reshape digital products, but whether you'll help define that future.
</Warning>
