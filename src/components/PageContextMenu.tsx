    ...
    <div className={cn('relative flex items-center shrink-0', className)}>
      <div className="flex items-stretch h-9 relative z-20">
        {firstOption && (
          <button
            className={cn(
              'rounded-l-xl px-3 text-stone-700 border border-stone-200 bg-white hover:bg-stone-50 h-full',
          ...
          >
            <div className="flex items-center gap-2 text-sm font-normal whitespace-nowrap">
              {firstOption.icon && (
        ...
        {options.length > 1 && (
          <button
            className="rounded-r-xl border border-stone-200 bg-white hover:bg-stone-50 aspect-square h-full flex items-center justify-center"
            ...
            {options.map((option) => (
              ...
              >
                ...
                <div className="flex flex-col min-w-0 flex-1">
                  <div className="text-sm font-normal text-stone-800 flex items-center gap-1">
                    {option.title}
                    {option.externalLink && (
                      <Icon
                        icon="arrow-up-right"
